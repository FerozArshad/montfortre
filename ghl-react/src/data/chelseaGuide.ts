/** Chelsea neighborhood-guide data from live WP + HTTrack capture. */

export const CHELSEA_MAP_CENTER = { lat: 40.747278451014, lng: -74.000755900279 };

export const CHELSEA_MAP_DEFAULT_QUERY = "Chelsea, Manhattan, New York, NY";

export const CHELSEA_POI_FILTERS = [
  { id: "hospital", title: "Hospitals", query: "hospitals near Chelsea New York NY" },
  { id: "school", title: "Schools", query: "schools near Chelsea New York NY" },
  { id: "park", title: "Parks", query: "parks near Chelsea New York NY" },
  { id: "station", title: "Transit Stations", query: "subway stations near Chelsea New York NY" },
  { id: "restaurant", title: "Restaurants", query: "restaurants near Chelsea New York NY" },
  { id: "supermarket", title: "Supermarkets", query: "supermarkets near Chelsea New York NY" },
] as const;

export const CHELSEA_AREA_LINKS = [
  { href: "#featured-listings", label: "Featured Listings" },
  { href: "#market-report", label: "Market Report" },
  { href: "#advice", label: "Local Advice" },
] as const;

export const CHELSEA_NEIGHBORHOODS = [
...
export const CHELSEA_YELP_CATS = [
...
export function googleMapsEmbedSrc(query: string) {
  const { lat, lng } = CHELSEA_MAP_CENTER;
  const center = `${lat},${lng}`;
  if (query === CHELSEA_MAP_DEFAULT_QUERY) {
