/** Frozen SEO for /top-harlem-new-york-townhouses-with-elevators/ — generated from HTTrack; do not invent values. */

import type { PageSeo } from "../../../seo/types";

export const ARTICLE_TITLE = "Top Harlem New York Townhouses With Elevators | Montfort Real Estate";

export const ARTICLE_METAS = [
  {
    "name": "description",
    "content": "Discover the rare gems of Harlem: renovated townhouses with private elevators! Click link to see more!"
  },
  {
    "name": "twitter:card",
  ...
  {
    "name": "twitter:title",
    "content": "Top Harlem New York Townhouses With Elevators | Montfort Real Estate"
  },
  {
  ...
  {
    "name": "twitter:image",
    "content": "https://assets.agentfire3.com/uploads/sites/312/2023/11/townhouses-with-elevators.png"
  },
  {
    "property": "og:locale",
    "content": "en_US"
  ...
  {
    "property": "og:url",
    "content": "https://montfortre.com/top-harlem-new-york-townhouses-with-elevators/"
  },
  {
  ...
  {
    "property": "og:image",
    "content": "https://assets.agentfire3.com/uploads/sites/312/2023/11/townhouses-with-elevators-682x1024.fit.png"
  },
  {
    "property": "article:published_time",
    "content": "2023-11-21T18:47:58+00:00"
  },
  {
    "property": "article:modified_time",
    "content": "2024-07-29T23:14:10+00:00"
  },
  {
...
export const ARTICLE_LINKS = [
  {
    "rel": "canonical",
    "href": "https://montfortre.com/top-harlem-new-york-townhouses-with-elevators/"
  },
  {
    "rel": "icon",
...
export const ARTICLE_JSON_LD = [
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"item\":{\"@id\":\"https://montfortre.com/\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":2,\"item\":{\"@id\":\"https://montfortre.com/top-harlem-new-york-townhouses-with-elevators/\",\"name\":\"Top Harlem New York Townhouses With Elevators\"}}]}",
