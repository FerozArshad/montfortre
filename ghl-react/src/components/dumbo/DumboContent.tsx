      ...
      <div className="hlm-listings-idx">
        <div className="hlm-listings-fallback">
          <p>
            ...
            on localhost and preview. Open the search to see Dumbo listings now.
          </p>
...
export default function DumboContent() {
  ...
  return (
    <>
      ...
      <section className="hlm-reviews" data-screen-label="Dumbo reviews">
      ...
      <section id="market-report" className="hlm-market" data-screen-label="Market report">
        <div className="hlm-market-inner">
          <div data-reveal="">
            <h2>Want the full market report for Dumbo?</h2>
          ...
          <div className="hlm-market-card" data-reveal="">
            <img src="/redesign-assets/hoods/dumbo.webp" alt="Dumbo" />
            <div className="hlm-market-card-copy">
              <div className="hlm-market-card-title">Dumbo</div>
