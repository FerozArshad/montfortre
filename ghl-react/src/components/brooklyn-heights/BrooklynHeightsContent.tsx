...
import { BROOKLYN_HEIGHTS_YELP_CATS } from "../../data/brooklynHeightsGuide";
import BROOKLYN_HEIGHTS_SCHOOLS from "../../data/brooklynHeightsSchools.json";
import BROOKLYN_HEIGHTS_YELP from "../../data/brooklynHeightsYelp.json";
...
type YelpCat = (typeof BROOKLYN_HEIGHTS_YELP_CATS)[number]["id"];
...
export default function BrooklynHeightsContent() {
  ...
  const areaPlaces = (BROOKLYN_HEIGHTS_YELP[areaCat] ?? []) as AreaPlace[];
  ...
  return (
    <>
      ...
      <section className="hlm-reviews" data-screen-label="Brooklyn Heights reviews">
      ...
      <HarlemSchools schools={BROOKLYN_HEIGHTS_SCHOOLS as School[]} nearLabel="Brooklyn Heights" />
        ...
        <div className="hlm-area-inner">
          <div className="hlm-area-head" data-reveal="">
            <div className="hlm-area-head-copy">
              ...
              <p>Browse through the top rated businesses that Brooklyn Heights has to offer!</p>
            </div>
            {areaPlaces.length ? (
          ...
          <div className="hlm-area-chips">
            {BROOKLYN_HEIGHTS_YELP_CATS.map((cat) => (
              <button
                key={cat.id}
                type="button"
