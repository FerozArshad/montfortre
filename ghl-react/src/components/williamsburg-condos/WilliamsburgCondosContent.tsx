...
export default function WilliamsburgCondosContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/hoods/williamsburg-condos.png" alt="Williamsburg condos" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Williamsburg" propertyType="Condo" label="Williamsburg condos" />
