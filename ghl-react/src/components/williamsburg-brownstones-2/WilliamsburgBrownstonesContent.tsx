...
export default function WilliamsburgBrownstonesContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/hoods/williamsburg-brownstones.png" alt="Williamsburg brownstones" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Williamsburg" propertyType="Brownstone" label="Williamsburg brownstones" />
