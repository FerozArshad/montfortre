...
export default function ChelseaCoOpsContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/hoods/chelsea-coops.png" alt="Chelsea co-op buildings" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Chelsea" propertyType="Co-op" label="Chelsea co-ops" />
