...
export default function HarlemBrownstonesContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/hoods/harlem-brownstones.png" alt="Harlem brownstones" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Harlem" propertyType="Brownstone" label="Harlem brownstones" />
