/** Frozen SEO for /bedford-stuyvesant-condos-2/ — do not edit values. */

import type { PageSeo } from "../types";

export const BEDFORD_STUYVESANT_CONDOS_TITLE = "Bedford stuyvesant Condos | Montfort Real Estate";

const DESCRIPTION =
  "Explore Bedford-Stuyvesant condos with Montfort Real Estate. Discover luxury condos, modern residences, and investment opportunities in the heart of Bed-Stuy Brooklyn.";

export const BEDFORD_STUYVESANT_CONDOS_METAS = [
  { name: "description", content: DESCRIPTION },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:description", content: DESCRIPTION },
  { name: "twitter:title", content: BEDFORD_STUYVESANT_CONDOS_TITLE },
  { property: "og:locale", content: "en_US" },
  { property: "og:type", content: "article" },
  { property: "og:title", content: BEDFORD_STUYVESANT_CONDOS_TITLE },
  { property: "og:description", content: DESCRIPTION },
  { property: "og:url", content: "https://montfortre.com/bedford-stuyvesant-condos-2/" },
...
export const BEDFORD_STUYVESANT_CONDOS_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/bedford-stuyvesant-condos-2/" },
...
export const BEDFORD_STUYVESANT_CONDOS_JSON_LD = [
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"item\":{\"@id\":\"https://montfortre.com/\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":2,\"item\":{\"@id\":\"https://montfortre.com/bedford-stuyvesant-condos-2/\",\"name\":\"Bedford stuyvesant Condos\"}}]}",
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"WebPage\",\"name\":\"Bedford stuyvesant Condos\",\"description\":\"Bedford-Stuyvesant Condos \\u2014 Local Market Expertise for Buyers, Sellers &amp; Investors We&#039;ll help you find a Bedford-Stuyvesant condo that fits your goals while avoiding unnecessary expenses, unfavorable building conditions, and overpaying in a competitive market Call 1-(646)-970-1078 Schedule A Consultation \\u2713SMOOTH TRANSACTIONWith limited risk throughout the buying process.\\u2713NO PRESSURENo pressure to overpay or purchase within a specific timeframe.\\u2713ONGOING SUPPORTA dedicated\",\"inLanguage\":\"en-US\",\"datePublished\":\"2026-05-19T06:33:34+00:00\",\"dateModified\":\"2026-07-29T12:42:43+00:00\",\"isPartOf\":{\"@type\":\"WebSite\",\"name\":\"Montfort Real Estate\",\"url\":\"https://montfortre.com/\"}}",
] as const;

export const BEDFORD_STUYVESANT_CONDOS_SEO: PageSeo = {
  title: BEDFORD_STUYVESANT_CONDOS_TITLE,
  metas: BEDFORD_STUYVESANT_CONDOS_METAS,
  links: BEDFORD_STUYVESANT_CONDOS_LINKS,
  jsonLd: BEDFORD_STUYVESANT_CONDOS_JSON_LD,
};
