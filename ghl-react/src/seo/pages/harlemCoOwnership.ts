/** Frozen SEO for /harlem-co-ownership/ — do not edit values. */

import type { PageSeo } from "../types";

export const HARLEM_CO_OWNERSHIP_TITLE = "Harlem Co-Ownership | Montfort Real Estate";

const DESCRIPTION =
  "Explore Harlem co-ownership opportunities with Montfort Real Estate. Learn how shared ownership works, discover investment strategies, and find co-owned properties in Harlem NYC.";

export const HARLEM_CO_OWNERSHIP_METAS = [
  { name: "description", content: DESCRIPTION },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:description", content: DESCRIPTION },
  { name: "twitter:title", content: HARLEM_CO_OWNERSHIP_TITLE },
  { property: "og:locale", content: "en_US" },
  { property: "og:type", content: "article" },
  { property: "og:title", content: HARLEM_CO_OWNERSHIP_TITLE },
  { property: "og:description", content: DESCRIPTION },
  { property: "og:url", content: "https://montfortre.com/harlem-co-ownership/" },
...
export const HARLEM_CO_OWNERSHIP_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/harlem-co-ownership/" },
...
export const HARLEM_CO_OWNERSHIP_JSON_LD = [
  ...
  '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"item":{"@id":"https://montfortre.com/","name":"Home"}},{"@type":"ListItem","position":2,"item":{"@id":"https://montfortre.com/harlem-co-ownership/","name":"Harlem Co-Ownership"}}]}',
  ...
  '{"@context":"https://schema.org","@type":"WebPage","name":"Harlem Co-Ownership","description":"Harlem Co-Ownership \u2014 Expert Guidance for Buyers, Sellers &amp; Investors We\u2019ll help you navigate Harlem co-ownership opportunities with confidence, avoiding partnership conflicts, hidden obligations, and costly mistakes Call 1-(646)-970-1078 Schedule A Consultation \u2713SMOOTH TRANSACTIONWith limited risk throughout the buying process.\u2713NO PRESSURENo pressure to overpay or purchase within a specific timeframe.\u2713ONGOING SUPPORTA dedicated team that remains available even after the transaction","inLanguage":"en-US","datePublished":"2026-05-19T06:09:53+00:00","dateModified":"2026-07-29T09:50:34+00:00","isPartOf":{"@type":"WebSite","name":"Montfort Real Estate","url":"https://montfortre.com/"}}',
] as const;

export const HARLEM_CO_OWNERSHIP_SEO: PageSeo = {
  title: HARLEM_CO_OWNERSHIP_TITLE,
  metas: HARLEM_CO_OWNERSHIP_METAS,
  links: HARLEM_CO_OWNERSHIP_LINKS,
  jsonLd: HARLEM_CO_OWNERSHIP_JSON_LD,
};
