# Sync (Gitea) - montfortre-com

**Warning:** `montfortre-com-full` holds secrets. Never add a GitHub remote to `.fullgit`.
...
## Refresh file mirror
```
robocopy "d:\montfortre\montfortre-com" "Z:\projects\montfortre-com" /MIR /R:1 /W:1 /MT:16 /XD node_modules .next dist build .venv venv __pycache__ target vendor .git .fullgit /XF *.log *.tmp
```
