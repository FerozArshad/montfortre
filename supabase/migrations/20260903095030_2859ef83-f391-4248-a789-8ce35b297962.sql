...
drop function if exists public.meta_pixel_save_config;
...
revoke all on function public.meta_pixel_save_config(text, boolean, boolean, boolean, boolean, boolean, boolean, text, text) from public, anon;
