-- Admin-managed Meta (Facebook) Pixel settings for the public React site.
...
-- Public read for the marketing site. Pixel IDs are not secret — they appear in page source.
