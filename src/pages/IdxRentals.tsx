...
const TITLE = "NYC Rentals | Montfort Real Estate";
const METAS = [
  {
    "name": "description",
    "content": "Search live MLS rental listings across Manhattan and Brooklyn with Montfort Real Estate."
  },
  {
    "property": "og:locale",
    "content": "en_US"
  ...
  {
    "property": "og:title",
    "content": "NYC Rentals | Montfort Real Estate"
  },
  {
  ...
  {
    "property": "og:url",
    "content": "https://montfortre.com/idx-rentals/"
  },
  {
...
const LINKS = [
  {
    "rel": "canonical",
    "href": "https://montfortre.com/idx-rentals/"
  }
];
...
<section style="background:#0F1729; padding:56px 64px 48px">
 <div style="max-width:1440px; margin:0 auto">
  ...
  <h1 style="font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:40px; color:#F9F6E6; margin:12px 0 8px">Rentals</h1>
  <p style="color:rgba(249,246,230,0.75); font-size:16px; margin:0; max-width:640px">Search live rental listings across Manhattan and Brooklyn, updated directly from the MLS.</p>
 </div>
</section>
<div class="idx-wrap">
 <div style="display:flex; justify-content:flex-end; margin-bottom:14px">
  <a href="https://stanley.olridx.com/Search/Rentals" target="_blank" rel="noopener" style="display:inline-flex; align-items:center; gap:9px; background:#113B5F; color:#F9F6E6; font-weight:700; font-size:12.5px; letter-spacing:0.09em; text-transform:uppercase; padding:13px 22px; border-radius:10px" style-hover="background:#C98A2C; color:#0F1729">Open full search in new tab
 ...
 <iframe class="idx-frame" src="https://stanley.olridx.com/Search/Rentals" scrolling="yes" title="Rentals" loading="lazy"></iframe>
