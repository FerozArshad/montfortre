 ...
 <section data-screen-label="Reviews" style="background:#F5EECB; padding:120px 64px; border-top:1px solid #E0D9B8; border-bottom:1px solid #E0D9B8">
  <div style="max-width:1440px; margin:0 auto">
   ...
   <div style="position:relative; margin-top:52px">
    ...
    <button id="review-prev" aria-label="Previous review" style="position:absolute; top:50%; left:-8px; transform:translateY(-50%); width:56px; height:56px; border-radius:100px; border:1px solid #C98A2C; background:#F9F6E6; color:#113B5F; display:flex; align-items:center; justify-content:center; cursor:pointer; box-shadow:0 12px 30px rgba(17,59,95,0.22); transition:background .25s ease, color .25s ease" style-hover="background:#113B5F; color:#F9F6E6"><svg width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M12.5 4.5L7 10l5.5 5.5" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"></path></svg></button>
    <button id="review-next" aria-label="Next review" style="position:absolute; top:50%; right:-8px; transform:translateY(-50%); width:56px; height:56px; border-radius:100px; border:1px solid #C98A2C; background:#F9F6E6; color:#113B5F; display:flex; align-items:center; justify-content:center; cursor:pointer; box-shadow:0 12px 30px rgba(17,59,95,0.22); transition:background .25s ease, color .25s ease" style-hover="background:#113B5F; color:#F9F6E6"><svg width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M7.5 4.5L13 10l-5.5 5.5" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"></path></svg></button>
   </div>
   <div id="review-dots" style="display:flex; align-items:center; justify-content:center; gap:10px; margin-top:32px">
    <button class="rev-dot" data-i="0" aria-label="Go to review 1" style="width:9px; height:9px; padding:0; border:0; border-radius:100px; background:#C98A2C; cursor:pointer; transition:background .25s ease, width .25s ease; width:28px;"></button>
    <button class="rev-dot" data-i="1" aria-label="Go to review 2" style="width:9px; height:9px; padding:0; border:0; border-radius:100px; background:#D9CFA6; cursor:pointer; transition:background .25s ease, width .25s ease; "></button>
    <button class="rev-dot" data-i="2" aria-label="Go to review 3" style="width:9px; height:9px; padding:0; border:0; border-radius:100px; background:#D9CFA6; cursor:pointer; transition:background .25s ease, width .25s ease; "></button>
    <button class="rev-dot" data-i="3" aria-label="Go to review 4" style="width:9px; height:9px; padding:0; border:0; border-radius:100px; background:#D9CFA6; cursor:pointer; transition:background .25s ease, width .25s ease; "></button>
    <button class="rev-dot" data-i="4" aria-label="Go to review 5" style="width:9px; height:9px; padding:0; border:0; border-radius:100px; background:#D9CFA6; cursor:pointer; transition:background .25s ease, width .25s ease; "></button>
    <button class="rev-dot" data-i="5" aria-label="Go to review 6" style="width:9px; height:9px; padding:0; border:0; border-radius:100px; background:#D9CFA6; cursor:pointer; transition:background .25s ease, width .25s ease; "></button>
   </div>
  </div>
 </section>
