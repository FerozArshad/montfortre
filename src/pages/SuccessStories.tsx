...
const TITLE = "Success Stories | Montfort Real Estate";
const METAS = [
  {
    "name": "description",
  ...
  {
    "name": "twitter:title",
    "content": "Success Stories | Montfort Real Estate"
  },
  {
  ...
  {
    "property": "og:url",
    "content": "https://montfortre.com/success-stories/"
  },
  {
...
const LINKS = [
  {
    "rel": "canonical",
    "href": "https://montfortre.com/success-stories/"
  },
  {
    "rel": "icon",
 ...
 * { box-sizing:border-box; }
 ...
 @media (max-width:1024px) {
  ...
  /* Testimonials masonry: 3 cols → 2 on tablet */
  [style*="column-count:3"] { column-count:2 !important; column-gap:20px !important; }
 ...
 @media (max-width:768px) {
  ...
  /* Testimonials: single column cards on phone */
  [style*="column-count:3"] { column-count:1 !important; column-gap:0 !important; }
  [style*="column-count:3"] > [data-reveal] {
    padding:22px 20px 20px !important;
    margin-bottom:16px !important;
  }
  [style*="column-count:3"] [style*="font-size:56px"] { font-size:40px !important; }
  ...
  /* Resources header */
  [style*="align-items:flex-end"][style*="justify-content:space-between"][style*="gap:56px"] {
    flex-direction:column !important;
...
<div style="width:100%; max-width:100%; background:#F9F6E6; overflow-x:hidden">
 ...
 <section data-screen-label="Success hero" style="position:relative; background:#0F1729; overflow:hidden; padding:96px 64px 90px">
  ...
  <div style="position:relative; z-index:2; max-width:900px; margin:0 auto; text-align:center">
   <div style="display:flex; align-items:center; justify-content:center; gap:14px">
    ...
    <span style="font-size:11.5px; font-weight:600; letter-spacing:0.18em; text-transform:uppercase; color:#F0D9A8">Client Reviews</span>
    <span style="width:34px; height:1px; background:#C98A2C; display:block"></span>
   </div>
   <h1 style="font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:56px; line-height:1.08; letter-spacing:-0.018em; color:#F9F6E6; margin:22px 0 0; text-wrap:pretty">Success stories</h1>
   <p style="font-size:19px; line-height:1.7; color:rgba(249,246,230,0.85); margin:20px auto 0; max-width:640px; text-wrap:pretty">Real reviews from New York buyers and sellers who trusted Stanley Montfort with one of the biggest decisions of their lives.</p>
   <a href="https://maps.google.com/?cid=11378470238102062088" target="_blank" rel="noopener" aria-label="Read verified Google reviews" style="display:inline-flex; align-items:center; gap:24px; margin-top:38px; background:#FFFFFF; border:1px solid rgba(201,138,44,0.6); border-radius:16px; box-shadow:0 22px 48px rgba(0,0,0,0.35); padding:18px 30px; white-space:nowrap; text-decoration:none; color:inherit">
    <div style="display:flex; flex-direction:column; gap:8px; padding-right:24px; border-right:1px solid #E0D9B8; text-align:left">
 ...
 <section data-screen-label="Testimonials" style="background:#F5EECB; padding:100px 64px; border-bottom:1px solid #E0D9B8">
  <div style="max-width:1280px; margin:0 auto; column-count:3; column-gap:24px">
    <div data-reveal="" style="break-inside:avoid; display:inline-block; width:100%; margin-bottom:24px; background:#F9F6E6; border:1px solid #E0D9B8; border-radius:16px; padding:30px 30px 26px; vertical-align:top">
     <div style="display:flex; align-items:flex-start; justify-content:space-between; gap:16px">
      <span style="font-family:Georgia,'Times New Roman',serif; font-size:56px; line-height:0.7; color:#C98A2C">&#8220;</span>
      <span style="color:#F5A623; font-size:16px; letter-spacing:0.1em; line-height:1; margin-top:8px">★★★★★</span>
     </div>
     <p style="font-size:16px; line-height:1.7; color:#3B4C5E; margin:6px 0 0; text-wrap:pretty">Stanley was great to work with. He worked with our schedule, took the time to understand our priorities, showed us a range of properties in different areas that could suit our needs and helped us strategize our approach. He was also a great resource in helping us find local connections for inspections, repairs, etc. We look forward to staying in touch with him and will definitely recommend him.</p>
     <div style="display:flex; align-items:center; gap:14px; margin-top:22px; padding-top:20px; border-top:1px solid #E0D9B8">
      <div style="position:relative; flex:0 0 auto; width:52px; height:52px; border-radius:50%; overflow:hidden; background:#113B5F; color:#F9F6E6; display:flex; align-items:center; justify-content:center; font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:17px">KS</div>
      <div style="flex:1 1 auto; min-width:0">
       <div style="font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:15.5px; color:#0F1729; text-wrap:pretty">Kristen Scheyder</div>
       <div style="display:flex; align-items:center; gap:8px; margin-top:3px">
        <img src="https://www.google.com/images/branding/googleg/1x/googleg_standard_color_128dp.png" alt="Google" style="width:15px; height:15px; display:block">
        <a href="https://www.google.com/maps/contrib/106383080176387870829/reviews?hl=en" target="_blank" rel="noopener" style="font-size:12.5px; color:#52677A" style-hover="color:#C98A2C">Jul 2026 · View on Google</a>
       </div>
      </div>
     </div>
    </div>
    <div data-reveal="" style="break-inside:avoid; display:inline-block; width:100%; margin-bottom:24px; background:#F9F6E6; border:1px solid #E0D9B8; border-radius:16px; padding:30px 30px 26px; vertical-align:top">
     ...
     <p style="font-size:16px; line-height:1.7; color:#3B4C5E; margin:6px 0 0; text-wrap:pretty">Incredible experience. Very knowledgeable about the brownstone buying process and helped me understand the budget differences for condo vs brownstones. Walked away more informed as a result.</p>
     <div style="display:flex; align-items:center; gap:14px; margin-top:22px; padding-top:20px; border-top:1px solid #E0D9B8">
      <div style="position:relative; flex:0 0 auto; width:52px; height:52px; border-radius:50%; overflow:hidden; background:#113B5F; color:#F9F6E6; display:flex; align-items:center; justify-content:center; font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:17px">AD</div>
      <div style="flex:1 1 auto; min-width:0">
       <div style="font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:15.5px; color:#0F1729; text-wrap:pretty">Angelina Darrisaw</div>
       <div style="display:flex; align-items:center; gap:8px; margin-top:3px">
        <img src="https://www.google.com/images/branding/googleg/1x/googleg_standard_color_128dp.png" alt="Google" style="width:15px; height:15px; display:block">
        <a href="https://www.google.com/maps/contrib/101694945511048714275/reviews?hl=en" target="_blank" rel="noopener" style="font-size:12.5px; color:#52677A" style-hover="color:#C98A2C">Jul 2026 · View on Google</a>
       </div>
      </div>
     </div>
    </div>
    <div data-reveal="" style="break-inside:avoid; display:inline-block; width:100%; margin-bottom:24px; background:#F9F6E6; border:1px solid #E0D9B8; border-radius:16px; padding:30px 30px 26px; vertical-align:top">
     ...
     <p style="font-size:16px; line-height:1.7; color:#3B4C5E; margin:6px 0 0; text-wrap:pretty">Great Service</p>
     <div style="display:flex; align-items:center; gap:14px; margin-top:22px; padding-top:20px; border-top:1px solid #E0D9B8">
      <div style="position:relative; flex:0 0 auto; width:52px; height:52px; border-radius:50%; overflow:hidden; background:#113B5F; color:#F9F6E6; display:flex; align-items:center; justify-content:center; font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:17px">SR</div>
      <div style="flex:1 1 auto; min-width:0">
       <div style="font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:15.5px; color:#0F1729; text-wrap:pretty">Stephie Rowe</div>
       <div style="display:flex; align-items:center; gap:8px; margin-top:3px">
        <img src="https://www.google.com/images/branding/googleg/1x/googleg_standard_color_128dp.png" alt="Google" style="width:15px; height:15px; display:block">
        <a href="https://www.google.com/maps/contrib/112594200448090017399/reviews?hl=en" target="_blank" rel="noopener" style="font-size:12.5px; color:#52677A" style-hover="color:#C98A2C">Jul 2026 · View on Google</a>
       </div>
      </div>
     </div>
    </div>
    <div data-reveal="" style="break-inside:avoid; display:inline-block; width:100%; margin-bottom:24px; background:#F9F6E6; border:1px solid #E0D9B8; border-radius:16px; padding:30px 30px 26px; vertical-align:top">
     ...
     <p style="font-size:16px; line-height:1.7; color:#3B4C5E; margin:6px 0 0; text-wrap:pretty">Thank you for a streamlined process from start to finish ensuring the right place was found and secured without haste!</p>
     <div style="display:flex; align-items:center; gap:14px; margin-top:22px; padding-top:20px; border-top:1px solid #E0D9B8">
      <div style="position:relative; flex:0 0 auto; width:52px; height:52px; border-radius:50%; overflow:hidden; background:#113B5F; color:#F9F6E6; display:flex; align-items:center; justify-content:center; font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:17px">SC</div>
      <div style="flex:1 1 auto; min-width:0">
       <div style="font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:15.5px; color:#0F1729; text-wrap:pretty">Sandrine Charles</div>
       <div style="display:flex; align-items:center; gap:8px; margin-top:3px">
        <img src="https://www.google.com/images/branding/googleg/1x/googleg_standard_color_128dp.png" alt="Google" style="width:15px; height:15px; display:block">
        <a href="https://www.google.com/maps/contrib/111964719774825390259/reviews?hl=en" target="_blank" rel="noopener" style="font-size:12.5px; color:#52677A" style-hover="color:#C98A2C">Jun 2026 · View on Google</a>
       </div>
      </div>
     </div>
    </div>
    <div data-reveal="" style="break-inside:avoid; display:inline-block; width:100%; margin-bottom:24px; background:#F9F6E6; border:1px solid #E0D9B8; border-radius:16px; padding:30px 30px 26px; vertical-align:top">
     ...
     <p style="font-size:16px; line-height:1.7; color:#3B4C5E; margin:6px 0 0; text-wrap:pretty">We had a great experience working with Stanley. He taught us a lot about the specific market we were looking in, which enabled us to make a very good decision on purchase of a new home.</p>
     <div style="display:flex; align-items:center; gap:14px; margin-top:22px; padding-top:20px; border-top:1px solid #E0D9B8">
      <div style="position:relative; flex:0 0 auto; width:52px; height:52px; border-radius:50%; overflow:hidden; background:#113B5F; color:#F9F6E6; display:flex; align-items:center; justify-content:center; font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:17px">SR</div>
      <div style="flex:1 1 auto; min-width:0">
       <div style="font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:15.5px; color:#0F1729; text-wrap:pretty">Seth Rabinowitz</div>
       <div style="display:flex; align-items:center; gap:8px; margin-top:3px">
        <img src="https://www.google.com/images/branding/googleg/1x/googleg_standard_color_128dp.png" alt="Google" style="width:15px; height:15px; display:block">
        <a href="https://www.google.com/maps/contrib/100922205373403327263/reviews?hl=en" target="_blank" rel="noopener" style="font-size:12.5px; color:#52677A" style-hover="color:#C98A2C">Jun 2026 · View on Google</a>
       </div>
      </div>
     </div>
    </div>
    <div data-reveal="" style="break-inside:avoid; display:inline-block; width:100%; margin-bottom:24px; background:#F9F6E6; border:1px solid #E0D9B8; border-radius:16px; padding:30px 30px 26px; vertical-align:top">
     ...
     <p style="font-size:16px; line-height:1.7; color:#3B4C5E; margin:6px 0 0; text-wrap:pretty">Stanley was the dream real estate agent we didn't know we deserved! From the beginning he was attentive to help us figure out what type of property we wanted, and could afford. Throughout the process he was a calm and patient presence, offering sincere and sage perspectives to keep us grounded. Ultimately we landed a unicorn of a property for below market price for the block. I'd highly recommend him for future homebuyers.</p>
     <div style="display:flex; align-items:center; gap:14px; margin-top:22px; padding-top:20px; border-top:1px solid #E0D9B8">
      <div style="position:relative; flex:0 0 auto; width:52px; height:52px; border-radius:50%; overflow:hidden; background:#113B5F; color:#F9F6E6; display:flex; align-items:center; justify-content:center; font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:17px">CA</div>
      <div style="flex:1 1 auto; min-width:0">
       <div style="font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:15.5px; color:#0F1729; text-wrap:pretty">Corey A. Witmer</div>
       <div style="display:flex; align-items:center; gap:8px; margin-top:3px">
        <img src="https://www.google.com/images/branding/googleg/1x/googleg_standard_color_128dp.png" alt="Google" style="width:15px; height:15px; display:block">
        <a href="https://www.google.com/maps/contrib/109328620676722096746/reviews?hl=en" target="_blank" rel="noopener" style="font-size:12.5px; color:#52677A" style-hover="color:#C98A2C">Apr 2026 · View on Google</a>
       </div>
      </div>
     </div>
    </div>
    <div data-reveal="" style="break-inside:avoid; display:inline-block; width:100%; margin-bottom:24px; background:#F9F6E6; border:1px solid #E0D9B8; border-radius:16px; padding:30px 30px 26px; vertical-align:top">
     ...
     <div style="display:flex; align-items:center; gap:14px; margin-top:22px; padding-top:20px; border-top:1px solid #E0D9B8">
      <div style="position:relative; flex:0 0 auto; width:52px; height:52px; border-radius:50%; overflow:hidden; background:#113B5F; color:#F9F6E6; display:flex; align-items:center; justify-content:center; font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:17px">PW</div>
      <div style="flex:1 1 auto; min-width:0">
       <div style="font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:15.5px; color:#0F1729; text-wrap:pretty">Perry Witmer</div>
       <div style="display:flex; align-items:center; gap:8px; margin-top:3px">
        <img src="https://www.google.com/images/branding/googleg/1x/googleg_standard_color_128dp.png" alt="Google" style="width:15px; height:15px; display:block">
        <a href="https://www.google.com/maps/contrib/116771421068638089471/reviews?hl=en" target="_blank" rel="noopener" style="font-size:12.5px; color:#52677A" style-hover="color:#C98A2C">Apr 2026 · View on Google</a>
       </div>
      </div>
     </div>
    </div>
    <div data-reveal="" style="break-inside:avoid; display:inline-block; width:100%; margin-bottom:24px; background:#F9F6E6; border:1px solid #E0D9B8; border-radius:16px; padding:30px 30px 26px; vertical-align:top">
     ...
     <p style="font-size:16px; line-height:1.7; color:#3B4C5E; margin:6px 0 0; text-wrap:pretty">Stan has been an incredibly patient, knowledgeable, and professional broker. He understands the market and has many relationships in the industry. He was thoughtful and gracious about responding to our feedback, and left no stone unturned in helping us find the property of our dreams. And he continues to provide guidance post-closing. Look no further!</p>
     <div style="display:flex; align-items:center; gap:14px; margin-top:22px; padding-top:20px; border-top:1px solid #E0D9B8">
      <div style="position:relative; flex:0 0 auto; width:52px; height:52px; border-radius:50%; overflow:hidden; background:#113B5F; color:#F9F6E6; display:flex; align-items:center; justify-content:center; font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:17px">DS</div>
      <div style="flex:1 1 auto; min-width:0">
       <div style="font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:15.5px; color:#0F1729; text-wrap:pretty">Davon Snipes</div>
       <div style="display:flex; align-items:center; gap:8px; margin-top:3px">
        <img src="https://www.google.com/images/branding/googleg/1x/googleg_standard_color_128dp.png" alt="Google" style="width:15px; height:15px; display:block">
        <a href="https://www.google.com/maps/contrib/108132066685824850224/reviews?hl=en" target="_blank" rel="noopener" style="font-size:12.5px; color:#52677A" style-hover="color:#C98A2C">Mar 2026 · View on Google</a>
       </div>
      </div>
     </div>
    </div>
    <div data-reveal="" style="break-inside:avoid; display:inline-block; width:100%; margin-bottom:24px; background:#F9F6E6; border:1px solid #E0D9B8; border-radius:16px; padding:30px 30px 26px; vertical-align:top">
     ...
     <p style="font-size:16px; line-height:1.7; color:#3B4C5E; margin:6px 0 0; text-wrap:pretty">Stan is extremely knowledgeable and professional. He also has the utmost patience! He helped me sell my home and purchase a condo at the same time. My home had all types of special contingencies but he found me a buyer very close to the price I wanted. Stan works extremely hard and is always accessible. I would give him more stars if I could. Highly recommend.</p>
     <div style="display:flex; align-items:center; gap:14px; margin-top:22px; padding-top:20px; border-top:1px solid #E0D9B8">
      <div style="position:relative; flex:0 0 auto; width:52px; height:52px; border-radius:50%; overflow:hidden; background:#113B5F; color:#F9F6E6; display:flex; align-items:center; justify-content:center; font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:17px">AN</div>
      <div style="flex:1 1 auto; min-width:0">
       <div style="font-family:'Space Grotesk',system-ui,sans-serif; font-weight:700; font-size:15.5px; color:#0F1729; text-wrap:pretty">Anika Nfr-Ka Ma’at Daniels</div>
       <div style="display:flex; align-items:center; gap:8px; margin-top:3px">
        <img src="https://www.google.com/images/branding/googleg/1x/googleg_standard_color_128dp.png" alt="Google" style="width:15px; height:15px; display:block">
        <a href="https://www.google.com/maps/contrib/107286042219082422872/reviews?hl=en" target="_blank" rel="noopener" style="font-size:12.5px; color:#52677A" style-hover="color:#C98A2C">Jan 2026 · View on Google</a>
       </div>
      </div>
     </div>
    </div>
