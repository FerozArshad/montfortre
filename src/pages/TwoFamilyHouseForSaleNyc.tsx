  ...
  <div style="position:relative; z-index:2; max-width:1440px; margin:0 auto; display:grid; grid-template-columns:1.02fr 0.98fr; gap:72px; align-items:center">
   ...
   <div data-reveal="" style="position:relative">
    <div style="position:relative; border-radius:16px; overflow:hidden; aspect-ratio:5/4; background:#E0D9B8; border:6px solid #FFFFFF; box-shadow:0 40px 90px rgba(17,59,95,0.28)">
     <img src="/redesign-assets/services/2-family-house-for-sale-nyc.webp" alt="2 family house for sale NYC" style="position:absolute; inset:0; width:100%; height:100%; object-fit:cover; display:block">
    </div>
 ...
 <section data-screen-label="Guide" style="background:#fff; padding:100px 64px; border-bottom:1px solid #E0D9B8">
  <div style="max-width:880px; margin:0 auto">
   <div data-reveal="">
    ...
    <div style="margin:34px 0 0; border-radius:16px; overflow:hidden; border:1px solid #E0D9B8; box-shadow:0 26px 54px rgba(17,59,95,0.14)"><img src="/redesign-assets/services/2-family-house-for-sale-nyc.webp" alt="2 family house for sale NYC" loading="lazy" style="display:block; width:100%; height:auto"></div>
    ...
    <div style="margin:34px 0 0; border-radius:16px; overflow:hidden; border:1px solid #E0D9B8; box-shadow:0 26px 54px rgba(17,59,95,0.14)"><img src="/redesign-assets/services/2-family-investment.webp" alt="Investment and appreciation for family house" loading="lazy" style="display:block; width:100%; height:auto"></div>
    ...
    <div style="margin:34px 0 0; border-radius:16px; overflow:hidden; border:1px solid #E0D9B8; box-shadow:0 26px 54px rgba(17,59,95,0.14)"><img src="/redesign-assets/services/mortgage.webp" alt="Mortgage calculator" loading="lazy" style="display:block; width:100%; height:auto"></div>
