/** Frozen SEO for /house-hacking-your-nyc-brownstone/ — generated from HTTrack; do not invent values. */

import type { PageSeo } from "../../../seo/types";

export const ARTICLE_TITLE = "House Hacking Your NYC Brownstone | Montfort Real Estate";

export const ARTICLE_METAS = [
  {
    "name": "description",
    "content": "If you own or are thinking of buying a New York City Brownstone, there are three main ways to begin house hacking. Click here to learn more!"
  },
  {
    "name": "twitter:card",
  ...
  {
    "name": "twitter:title",
    "content": "House Hacking Your NYC Brownstone | Montfort Real Estate"
  },
  {
  ...
  {
    "name": "twitter:image",
    "content": "https://montfortre.com/redesign-assets/blog/house-hacking-your-nyc-brownstone/featured-Montfort-Real-Estate-Stanley-Montfort-NewYork-Real-Estate-Agent-Brownstones3.jpg"
  },
  {
    "property": "og:locale",
    "content": "en_US"
  ...
  {
    "property": "og:url",
    "content": "https://montfortre.com/house-hacking-your-nyc-brownstone/"
  },
  {
  ...
  },
  {
    ...
    "content": "2022-11-11T20:45:11+00:00"
  },
  {
    "property": "article:modified_time",
    "content": "2024-06-15T20:48:33+00:00"
  },
  {
...
export const ARTICLE_LINKS = [
  {
    "rel": "canonical",
    "href": "https://montfortre.com/house-hacking-your-nyc-brownstone/"
  },
  {
    "rel": "icon",
...
export const ARTICLE_JSON_LD = [
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"item\":{\"@id\":\"https://montfortre.com/\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":2,\"item\":{\"@id\":\"https://montfortre.com/house-hacking-your-nyc-brownstone/\",\"name\":\"House Hacking Your NYC Brownstone\"}}]}",
