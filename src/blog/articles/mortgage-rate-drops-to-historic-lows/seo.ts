/** Frozen SEO for /mortgage-rate-drops-to-historic-lows/ — generated from HTTrack; do not invent values. */

import type { PageSeo } from "../../../seo/types";

export const ARTICLE_TITLE = "Mortgage Rate Drops to Historic Lows!! | Montfort Real Estate";

export const ARTICLE_METAS = [
  {
    "name": "description",
    "content": "In the last week, mortgage rates have gotten even more affordable and have reached an all-time low. As stay-at-home orders are beginning to lift across the nation, this is music to the ears of many potential homebuyers who were already considering purchasing a home before the Coronavirus pandemic hit the US."
  },
  {
    "name": "twitter:card",
  ...
  {
    "name": "twitter:title",
    "content": "Mortgage Rate Drops to Historic Lows!! | Montfort Real Estate"
  },
  {
  ...
  {
    "name": "twitter:image",
    "content": "https://montfortre.com/redesign-assets/blog/mortgage-rate-drops-to-historic-lows/featured-Mortgage-Rate-Drops-to-Historic-Lows.png"
  },
  {
    "property": "og:locale",
    "content": "en_US"
  ...
  {
    "property": "og:url",
    "content": "https://montfortre.com/mortgage-rate-drops-to-historic-lows/"
  },
  {
  ...
  },
  {
    ...
    "content": "2021-07-13T14:30:03+00:00"
  },
  {
    "property": "article:modified_time",
    "content": "2023-11-22T21:20:45+00:00"
  },
  {
...
export const ARTICLE_LINKS = [
  {
    "rel": "canonical",
    "href": "https://montfortre.com/mortgage-rate-drops-to-historic-lows/"
  },
  {
    "rel": "icon",
...
export const ARTICLE_JSON_LD = [
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"item\":{\"@id\":\"https://montfortre.com/\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":2,\"item\":{\"@id\":\"https://montfortre.com/mortgage-rate-drops-to-historic-lows/\",\"name\":\"Mortgage Rate Drops to Historic Lows!!\"}}]}",
