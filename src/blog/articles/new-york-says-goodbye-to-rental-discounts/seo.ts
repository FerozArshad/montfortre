/** Frozen SEO for /new-york-says-goodbye-to-rental-discounts/ — generated from HTTrack; do not invent values. */

import type { PageSeo } from "../../../seo/types";

export const ARTICLE_TITLE = "New York Says Goodbye to Rental Discounts | Montfort Real Estate";

export const ARTICLE_METAS = [
  {
    "name": "description",
    "content": "When hoards of tenants all across the city fled to the suburbs and more ideal living situations amid the Covid-19 pandemic, landlords felt the blow. Now, as the city attempts a return to normalcy, it’s the renters taking the heat."
  },
  {
    "name": "twitter:card",
  ...
  {
    "name": "twitter:title",
    "content": "New York Says Goodbye to Rental Discounts | Montfort Real Estate"
  },
  {
  ...
  {
    "name": "twitter:image",
    "content": "https://assets.agentfire3.com/uploads/sites/312/2021/10/Blog-New-York-Says-Goodbye-to-Rental-Discounts.jpg"
  },
  {
    "property": "og:locale",
    "content": "en_US"
  ...
  {
    "property": "og:url",
    "content": "https://montfortre.com/new-york-says-goodbye-to-rental-discounts/"
  },
  {
  ...
  {
    "property": "og:image",
    "content": "https://assets.agentfire3.com/uploads/sites/312/2021/10/Blog-New-York-Says-Goodbye-to-Rental-Discounts-1024x683.jpg"
  },
  {
    "property": "article:published_time",
    "content": "2021-10-20T18:37:39+00:00"
  },
  {
    "property": "article:modified_time",
    "content": "2023-11-22T21:18:52+00:00"
  },
  {
...
export const ARTICLE_LINKS = [
  {
    "rel": "canonical",
    "href": "https://montfortre.com/new-york-says-goodbye-to-rental-discounts/"
  },
  {
    "rel": "icon",
...
export const ARTICLE_JSON_LD = [
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"item\":{\"@id\":\"https://montfortre.com/\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":2,\"item\":{\"@id\":\"https://montfortre.com/new-york-says-goodbye-to-rental-discounts/\",\"name\":\"New York Says Goodbye to Rental Discounts\"}}]}",
