/** Williamsburg neighborhood-guide data from live WP + HTTrack capture. */

export const WILLIAMSBURG_MAP_CENTER = { lat: 40.710137254769, lng: -73.958698293993 };

export const WILLIAMSBURG_MAP_DEFAULT_QUERY = "Williamsburg, Brooklyn, New York, NY";

export const WILLIAMSBURG_POI_FILTERS = [
  { id: "hospital", title: "Hospitals", query: "hospitals near Williamsburg Brooklyn New York NY" },
  { id: "school", title: "Schools", query: "schools near Williamsburg Brooklyn New York NY" },
  { id: "park", title: "Parks", query: "parks near Williamsburg Brooklyn New York NY" },
  { id: "station", title: "Transit Stations", query: "subway stations near Williamsburg Brooklyn New York NY" },
  { id: "restaurant", title: "Restaurants", query: "restaurants near Williamsburg Brooklyn New York NY" },
  { id: "supermarket", title: "Supermarkets", query: "supermarkets near Williamsburg Brooklyn New York NY" },
] as const;

export const WILLIAMSBURG_AREA_LINKS = [
  { href: "#featured-listings", label: "Featured Listings" },
  { href: "#market-report", label: "Market Report" },
  { href: "#advice", label: "Local Advice" },
] as const;

export const WILLIAMSBURG_NEIGHBORHOODS = [
...
export const WILLIAMSBURG_AGENT = {
...
export const WILLIAMSBURG_YELP_CATS = [
...
export function googleMapsEmbedSrc(query: string) {
  const { lat, lng } = WILLIAMSBURG_MAP_CENTER;
  const center = `${lat},${lng}`;
  if (query === WILLIAMSBURG_MAP_DEFAULT_QUERY) {
