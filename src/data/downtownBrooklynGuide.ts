/** Downtown Brooklyn neighborhood-guide data from live WP + HTTrack capture. */

export const DOWNTOWN_BROOKLYN_MAP_CENTER = { lat: 40.693914537057, lng: -73.985341054854 };

export const DOWNTOWN_BROOKLYN_MAP_DEFAULT_QUERY = "Downtown Brooklyn, Brooklyn, New York, NY";

export const DOWNTOWN_BROOKLYN_POI_FILTERS = [
  { id: "hospital", title: "Hospitals", query: "hospitals near Downtown Brooklyn New York NY" },
  { id: "school", title: "Schools", query: "schools near Downtown Brooklyn New York NY" },
  { id: "park", title: "Parks", query: "parks near Downtown Brooklyn New York NY" },
  { id: "station", title: "Transit Stations", query: "subway stations near Downtown Brooklyn New York NY" },
  { id: "restaurant", title: "Restaurants", query: "restaurants near Downtown Brooklyn New York NY" },
  { id: "supermarket", title: "Supermarkets", query: "supermarkets near Downtown Brooklyn New York NY" },
] as const;

export const DOWNTOWN_BROOKLYN_AREA_LINKS = [
  { href: "#featured-listings", label: "Featured Listings" },
  { href: "#market-report", label: "Market Report" },
  { href: "#advice", label: "Local Advice" },
] as const;

export const DOWNTOWN_BROOKLYN_NEIGHBORHOODS = [
...
export const DOWNTOWN_BROOKLYN_AGENT = {
...
export const DOWNTOWN_BROOKLYN_YELP_CATS = [
...
export function googleMapsEmbedSrc(query: string) {
  const { lat, lng } = DOWNTOWN_BROOKLYN_MAP_CENTER;
  const center = `${lat},${lng}`;
  if (query === DOWNTOWN_BROOKLYN_MAP_DEFAULT_QUERY) {
