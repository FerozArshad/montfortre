/** Bedford-Stuyvesant neighborhood-guide data from live WP + HTTrack capture. */

export const BEDFORD_STUYVESANT_MAP_DEFAULT_QUERY = "Bedford-Stuyvesant, Brooklyn, New York, NY";

export const BEDFORD_STUYVESANT_POI_FILTERS = [
  { id: "hospital", title: "Hospitals", query: "hospitals near Bedford-Stuyvesant Brooklyn New York NY" },
...
export const BEDFORD_STUYVESANT_NEIGHBORHOODS = [
...
export const BEDFORD_STUYVESANT_AGENT = {
...
export const BEDFORD_STUYVESANT_YELP_CATS = [
...
export function googleMapsEmbedSrc(query: string) {
  return `https://maps.google.com/maps?q=${encodeURIComponent(query)}&z=14&hl=en&t=m&output=embed&iwloc=near`;
}
