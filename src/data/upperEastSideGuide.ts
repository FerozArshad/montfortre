/** Upper East Side neighborhood-guide data from live WP + HTTrack capture. */

export const UES_MAP_CENTER = { lat: 40.773065781198, lng: -73.956297438172 };

export const UES_MAP_DEFAULT_QUERY = "Upper East Side, Manhattan, New York, NY";

export const UES_POI_FILTERS = [
  { id: "hospital", title: "Hospitals", query: "hospitals near Upper East Side New York NY" },
  { id: "school", title: "Schools", query: "schools near Upper East Side New York NY" },
  { id: "park", title: "Parks", query: "parks near Upper East Side New York NY" },
  { id: "station", title: "Transit Stations", query: "subway stations near Upper East Side New York NY" },
  { id: "restaurant", title: "Restaurants", query: "restaurants near Upper East Side New York NY" },
  { id: "supermarket", title: "Supermarkets", query: "supermarkets near Upper East Side New York NY" },
] as const;

export const UES_AREA_LINKS = [
  { href: "#featured-listings", label: "Featured Listings" },
  { href: "#market-report", label: "Market Report" },
  { href: "#advice", label: "Local Advice" },
] as const;

export const UES_NEIGHBORHOODS = [
...
export function googleMapsEmbedSrc(query: string) {
  const { lat, lng } = UES_MAP_CENTER;
  const center = `${lat},${lng}`;
  if (query === UES_MAP_DEFAULT_QUERY) {
