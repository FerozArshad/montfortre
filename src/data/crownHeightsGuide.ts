/** Crown Heights neighborhood-guide data from live WP + HTTrack capture. */

export const CROWN_HEIGHTS_MAP_CENTER = { lat: 40.671403495064, lng: -73.943727701265 };

export const CROWN_HEIGHTS_MAP_DEFAULT_QUERY = "Crown Heights, Brooklyn, New York, NY";

export const CROWN_HEIGHTS_POI_FILTERS = [
  { id: "hospital", title: "Hospitals", query: "hospitals near Crown Heights Brooklyn New York NY" },
  { id: "school", title: "Schools", query: "schools near Crown Heights Brooklyn New York NY" },
  { id: "park", title: "Parks", query: "parks near Crown Heights Brooklyn New York NY" },
  { id: "station", title: "Transit Stations", query: "subway stations near Crown Heights Brooklyn New York NY" },
  { id: "restaurant", title: "Restaurants", query: "restaurants near Crown Heights Brooklyn New York NY" },
  { id: "supermarket", title: "Supermarkets", query: "supermarkets near Crown Heights Brooklyn New York NY" },
] as const;

export const CROWN_HEIGHTS_AREA_LINKS = [
  { href: "#featured-listings", label: "Featured Listings" },
  { href: "#market-report", label: "Market Report" },
  { href: "#advice", label: "Local Advice" },
] as const;

export const CROWN_HEIGHTS_NEIGHBORHOODS = [
...
export const CROWN_HEIGHTS_AGENT = {
...
export const CROWN_HEIGHTS_YELP_CATS = [
...
export function googleMapsEmbedSrc(query: string) {
  const { lat, lng } = CROWN_HEIGHTS_MAP_CENTER;
  const center = `${lat},${lng}`;
  if (query === CROWN_HEIGHTS_MAP_DEFAULT_QUERY) {
