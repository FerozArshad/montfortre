/** Frozen SEO for /harlem-sros/ — do not edit values. */

import type { PageSeo } from "../types";

export const HARLEM_SROS_TITLE = "Harlem SROS | Montfort Real Estate";

const DESCRIPTION =
  "Explore Harlem SRO properties with Montfort Real Estate. Learn about Single Room Occupancy investments, financing, regulations, and opportunities in Harlem NYC.";

export const HARLEM_SROS_METAS = [
  { name: "description", content: DESCRIPTION },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:description", content: DESCRIPTION },
  { name: "twitter:title", content: HARLEM_SROS_TITLE },
  { property: "og:locale", content: "en_US" },
  { property: "og:type", content: "article" },
  { property: "og:title", content: HARLEM_SROS_TITLE },
  { property: "og:description", content: DESCRIPTION },
  { property: "og:url", content: "https://montfortre.com/harlem-sros/" },
...
export const HARLEM_SROS_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/harlem-sros/" },
...
export const HARLEM_SROS_JSON_LD = [
  ...
  '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"item":{"@id":"https://montfortre.com/","name":"Home"}},{"@type":"ListItem","position":2,"item":{"@id":"https://montfortre.com/harlem-sros/","name":"Harlem SROS"}}]}',
  ...
  '{"@context":"https://schema.org","@type":"WebPage","name":"Harlem SROS","description":"Harlem SROs \u2014 Expert Guidance for Buyers, Sellers &amp; Investors We\u2019ll help you identify profitable Harlem SRO opportunities while minimizing regulatory, compliance, and management-related risks Call 1-(646)-970-1078 Schedule A Consultation \u2713SMOOTH TRANSACTIONWith limited risk throughout the buying process.\u2713NO PRESSURENo pressure to overpay or purchase within a specific timeframe.\u2713ONGOING SUPPORTA dedicated team that remains available even after the transaction is complete.","inLanguage":"en-US","datePublished":"2026-05-19T06:08:35+00:00","dateModified":"2026-07-29T09:46:38+00:00","isPartOf":{"@type":"WebSite","name":"Montfort Real Estate","url":"https://montfortre.com/"}}',
] as const;

export const HARLEM_SROS_SEO: PageSeo = {
  title: HARLEM_SROS_TITLE,
  metas: HARLEM_SROS_METAS,
  links: HARLEM_SROS_LINKS,
  jsonLd: HARLEM_SROS_JSON_LD,
};
