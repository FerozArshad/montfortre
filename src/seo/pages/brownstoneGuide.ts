/** Frozen SEO for /advice-for-buyers-looking-to-purchase-brownstones/ — do not edit values. */

import type { PageSeo } from "../types";

export const BROWNSTONE_GUIDE_TITLE = "Brownstone Buying Guide for Buyers | Montfort Real Estate";

export const BROWNSTONE_GUIDE_METAS = [
  {
    "name": "description",
...
export const BROWNSTONE_GUIDE_LINKS = [
  {
    "rel": "canonical",
...
export const BROWNSTONE_GUIDE_JSON_LD = [
...
export const BROWNSTONE_GUIDE_SEO: PageSeo = {
  title: BROWNSTONE_GUIDE_TITLE,
  metas: BROWNSTONE_GUIDE_METAS,
  links: BROWNSTONE_GUIDE_LINKS,
  jsonLd: BROWNSTONE_GUIDE_JSON_LD,
};
