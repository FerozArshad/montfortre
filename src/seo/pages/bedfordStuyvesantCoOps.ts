/** Frozen SEO for /bedford-stuyvesant-co-ops-2/ — do not edit values. */

import type { PageSeo } from "../types";

export const BEDFORD_STUYVESANT_CO_OPS_TITLE = "Bedford stuyvesant Co-Ops | Montfort Real Estate";

const DESCRIPTION =
  "Explore Bedford-Stuyvesant co-ops with Montfort Real Estate. Discover co-op apartments, historic residences, and investment opportunities in the heart of Bed-Stuy Brooklyn";

export const BEDFORD_STUYVESANT_CO_OPS_METAS = [
  { name: "description", content: DESCRIPTION },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:description", content: DESCRIPTION },
  { name: "twitter:title", content: BEDFORD_STUYVESANT_CO_OPS_TITLE },
  { property: "og:locale", content: "en_US" },
  { property: "og:type", content: "article" },
  { property: "og:title", content: BEDFORD_STUYVESANT_CO_OPS_TITLE },
  { property: "og:description", content: DESCRIPTION },
  { property: "og:url", content: "https://montfortre.com/bedford-stuyvesant-co-ops-2/" },
...
export const BEDFORD_STUYVESANT_CO_OPS_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/bedford-stuyvesant-co-ops-2/" },
...
export const BEDFORD_STUYVESANT_CO_OPS_JSON_LD = [
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"item\":{\"@id\":\"https://montfortre.com/\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":2,\"item\":{\"@id\":\"https://montfortre.com/bedford-stuyvesant-co-ops-2/\",\"name\":\"Bedford stuyvesant Co-Ops\"}}]}",
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"WebPage\",\"name\":\"Bedford stuyvesant Co-Ops\",\"description\":\"Bedford-Stuyvesant Co-Ops \\u2014 Trusted Guidance for Buyers, Sellers &amp; Investors We&#039;ll guide you through the co-op buying process, helping you avoid restrictive building policies, financial risks, and costly mistakes that can delay approval Call 1-(646)-970-1078 Schedule A Consultation \\u2713SMOOTH TRANSACTIONWith limited risk throughout the buying process.\\u2713NO PRESSURENo pressure to overpay or purchase within a specific timeframe.\\u2713ONGOING SUPPORTA dedicated team that\",\"inLanguage\":\"en-US\",\"datePublished\":\"2026-05-19T06:34:47+00:00\",\"dateModified\":\"2026-07-29T12:51:32+00:00\",\"isPartOf\":{\"@type\":\"WebSite\",\"name\":\"Montfort Real Estate\",\"url\":\"https://montfortre.com/\"}}",
] as const;

export const BEDFORD_STUYVESANT_CO_OPS_SEO: PageSeo = {
  title: BEDFORD_STUYVESANT_CO_OPS_TITLE,
  metas: BEDFORD_STUYVESANT_CO_OPS_METAS,
  links: BEDFORD_STUYVESANT_CO_OPS_LINKS,
  jsonLd: BEDFORD_STUYVESANT_CO_OPS_JSON_LD,
};
