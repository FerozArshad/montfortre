/** Frozen SEO for /bedford-stuyvesant-sros-2/ — do not edit values. */

import type { PageSeo } from "../types";

export const BEDFORD_STUYVESANT_SROS_TITLE = "Bedford stuyvesant SROs | Montfort Real Estate";

const DESCRIPTION =
  "Explore Bedford-Stuyvesant SRO properties with Montfort Real Estate. Learn about Single Room Occupancy investments, financing, and multifamily opportunities in Bed-Stuy Brooklyn";

export const BEDFORD_STUYVESANT_SROS_METAS = [
  ...
  { property: "og:title", content: BEDFORD_STUYVESANT_SROS_TITLE },
...
export const BEDFORD_STUYVESANT_SROS_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/bedford-stuyvesant-sros-2/" },
...
export const BEDFORD_STUYVESANT_SROS_JSON_LD = [
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"item\":{\"@id\":\"https://montfortre.com/\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":2,\"item\":{\"@id\":\"https://montfortre.com/bedford-stuyvesant-sros-2/\",\"name\":\"Bedford stuyvesant SROs\"}}]}",
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"WebPage\",\"name\":\"Bedford stuyvesant SROs\",\"description\":\"Bedford-Stuyvesant SROs \\u2014 Specialized Insights for Buyers, Sellers &amp; Investors We&#039;ll help you evaluate Bedford-Stuyvesant SRO opportunities with confidence by identifying potential compliance concerns, maintenance liabilities, and investment risks before you buy Call 1-(646)-970-1078 Schedule A Consultation \\u2713SMOOTH TRANSACTIONWith limited risk throughout the buying process.\\u2713NO PRESSURENo pressure to overpay or purchase within a specific timeframe.\\u2713ONGOING SUPPORTA dedicated team that remains\",\"inLanguage\":\"en-US\",\"datePublished\":\"2026-05-19T06:35:24+00:00\",\"dateModified\":\"2026-07-29T12:52:55+00:00\",\"isPartOf\":{\"@type\":\"WebSite\",\"name\":\"Montfort Real Estate\",\"url\":\"https://montfortre.com/\"}}",
] as const;

export const BEDFORD_STUYVESANT_SROS_SEO: PageSeo = {
  title: BEDFORD_STUYVESANT_SROS_TITLE,
  metas: BEDFORD_STUYVESANT_SROS_METAS,
  links: BEDFORD_STUYVESANT_SROS_LINKS,
  jsonLd: BEDFORD_STUYVESANT_SROS_JSON_LD,
};
