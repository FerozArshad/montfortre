/** Frozen SEO for /crown-heights-co-ownership-2/ — do not edit values. */

import type { PageSeo } from "../types";

export const CROWN_HEIGHTS_CO_OWNERSHIP_TITLE = "Crown Heights Co-Ownership | Montfort Real Estate";

const DESCRIPTION =
  "Explore Crown Heights co-ownership opportunities with Montfort Real Estate. Learn about shared ownership, investment partnerships, and affordable property strategies in Crown Heights Brooklyn";

export const CROWN_HEIGHTS_CO_OWNERSHIP_METAS = [
  { name: "description", content: DESCRIPTION },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:description", content: DESCRIPTION },
  { name: "twitter:image", content: "https://montfortre.com/redesign-assets/og/crown-heights.png" },
  { name: "twitter:title", content: CROWN_HEIGHTS_CO_OWNERSHIP_TITLE },
  { property: "og:locale", content: "en_US" },
  { property: "og:type", content: "article" },
  { property: "og:title", content: CROWN_HEIGHTS_CO_OWNERSHIP_TITLE },
  { property: "og:description", content: DESCRIPTION },
  { property: "og:url", content: "https://montfortre.com/crown-heights-co-ownership-2/" },
  { property: "og:site_name", content: "Montfort Real Estate" },
  { property: "og:image", content: "https://montfortre.com/redesign-assets/og/crown-heights.png" },
  { property: "article:publisher", content: "https://www.facebook.com/montfortrealestate" },
] as const;

export const CROWN_HEIGHTS_CO_OWNERSHIP_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/crown-heights-co-ownership-2/" },
...
export const CROWN_HEIGHTS_CO_OWNERSHIP_JSON_LD = [
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"item\":{\"@id\":\"https://montfortre.com/\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":2,\"item\":{\"@id\":\"https://montfortre.com/crown-heights-co-ownership-2/\",\"name\":\"Crown Heights Co-Ownership\"}}]}",
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"WebPage\",\"name\":\"Crown Heights Co-Ownership\",\"description\":\"Crown Heights Co-Ownership \\u2014 Local Experts for Buying, Selling &amp; Investing We&#039;ll help you make a smart co-ownership investment in Crown Heights by structuring the purchase properly, reducing risk, and protecting everyone&#039;s interests. Call 1-(646)-970-1078 Schedule A Consultation \\u2713SMOOTH TRANSACTIONWith limited risk throughout the buying process.\\u2713NO PRESSURENo pressure to overpay or purchase within a specific timeframe.\\u2713ONGOING SUPPORTA dedicated team that\",\"inLanguage\":\"en-US\",\"datePublished\":\"2026-05-19T06:48:32+00:00\",\"dateModified\":\"2026-07-29T13:06:23+00:00\",\"isPartOf\":{\"@type\":\"WebSite\",\"name\":\"Montfort Real Estate\",\"url\":\"https://montfortre.com/\"}}",
] as const;

export const CROWN_HEIGHTS_CO_OWNERSHIP_SEO: PageSeo = {
  title: CROWN_HEIGHTS_CO_OWNERSHIP_TITLE,
  metas: CROWN_HEIGHTS_CO_OWNERSHIP_METAS,
  links: CROWN_HEIGHTS_CO_OWNERSHIP_LINKS,
  jsonLd: CROWN_HEIGHTS_CO_OWNERSHIP_JSON_LD,
};
