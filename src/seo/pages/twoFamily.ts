/** Frozen SEO for /2-family-house-for-sale-nyc/ — do not edit values. */

import type { PageSeo } from "../types";

export const TWO_FAMILY_TITLE = "2 Family house for sale NYC | Montfort Real Estate";

export const TWO_FAMILY_METAS = [
  {
    "name": "description",
...
export const TWO_FAMILY_JSON_LD = [
...
export const TWO_FAMILY_SEO: PageSeo = {
  title: TWO_FAMILY_TITLE,
  metas: TWO_FAMILY_METAS,
  links: TWO_FAMILY_LINKS,
  jsonLd: TWO_FAMILY_JSON_LD,
};
