/** Frozen SEO for /brooklyn-heights-townhouses-2/ — do not edit values. */

import type { PageSeo } from "../types";

export const BROOKLYN_HEIGHTS_TOWNHOUSES_TITLE = "Brooklyn Heights Townhouses | Montfort Real Estate";

const DESCRIPTION =
  "Explore Brooklyn Heights townhouses with Montfort Real Estate. Discover historic brownstones, luxury townhomes, and investment opportunities in one of Brooklyn’s most prestigious neighborhoods.";

export const BROOKLYN_HEIGHTS_TOWNHOUSES_METAS = [
  { name: "description", content: DESCRIPTION },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:description", content: DESCRIPTION },
  { name: "twitter:image", content: "https://montfortre.com/redesign-assets/og/brooklyn-heights.png" },
  { name: "twitter:title", content: BROOKLYN_HEIGHTS_TOWNHOUSES_TITLE },
  { property: "og:locale", content: "en_US" },
  { property: "og:type", content: "article" },
  { property: "og:title", content: BROOKLYN_HEIGHTS_TOWNHOUSES_TITLE },
  { property: "og:description", content: DESCRIPTION },
  { property: "og:url", content: "https://montfortre.com/brooklyn-heights-townhouses-2/" },
  { property: "og:site_name", content: "Montfort Real Estate" },
  { property: "og:image", content: "https://montfortre.com/redesign-assets/og/brooklyn-heights.png" },
  { property: "article:publisher", content: "https://www.facebook.com/montfortrealestate" },
] as const;

export const BROOKLYN_HEIGHTS_TOWNHOUSES_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/brooklyn-heights-townhouses-2/" },
...
export const BROOKLYN_HEIGHTS_TOWNHOUSES_JSON_LD = [
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"item\":{\"@id\":\"https://montfortre.com/\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":2,\"item\":{\"@id\":\"https://montfortre.com/brooklyn-heights-townhouses-2/\",\"name\":\"Brooklyn Heights Townhouses\"}}]}",
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"WebPage\",\"name\":\"Brooklyn Heights Townhouses\",\"description\":\"Brooklyn Heights Townhouses \\u2014 Expert Guidance for Buyers, Sellers &amp; Investors We\\u2019ll help you purchase the right Brooklyn Heights townhouse by identifying hidden maintenance concerns, evaluating long-term value, and negotiating the best possible terms on your behalf Call 1-(646)-970-1078 Schedule A Consultation \\u2713SMOOTH TRANSACTIONWith limited risk throughout the buying process.\\u2713NO PRESSURENo pressure to overpay or purchase within a specific timeframe.\\u2713ONGOING\",\"inLanguage\":\"en-US\",\"datePublished\":\"2026-05-19T06:29:58+00:00\",\"dateModified\":\"2026-07-29T12:08:36+00:00\",\"isPartOf\":{\"@type\":\"WebSite\",\"name\":\"Montfort Real Estate\",\"url\":\"https://montfortre.com/\"}}",
] as const;

export const BROOKLYN_HEIGHTS_TOWNHOUSES_SEO: PageSeo = {
  title: BROOKLYN_HEIGHTS_TOWNHOUSES_TITLE,
  metas: BROOKLYN_HEIGHTS_TOWNHOUSES_METAS,
  links: BROOKLYN_HEIGHTS_TOWNHOUSES_LINKS,
  jsonLd: BROOKLYN_HEIGHTS_TOWNHOUSES_JSON_LD,
};
