/** Frozen SEO for /downtown-brooklyn-condos-2/ — do not edit values. */

import type { PageSeo } from "../types";

export const DOWNTOWN_BROOKLYN_CONDOS_TITLE = "Downtown Brooklyn Condos | Montfort Real Estate";

const DESCRIPTION =
  "Explore Downtown Brooklyn condos with Montfort Real Estate. Discover luxury condos, modern residences, and investment opportunities in one of Brooklyn’s fastest-growing neighborhoods.";

export const DOWNTOWN_BROOKLYN_CONDOS_METAS = [
  { name: "description", content: DESCRIPTION },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:description", content: DESCRIPTION },
  { name: "twitter:image", content: "https://montfortre.com/redesign-assets/og/downtown-brooklyn.png" },
  { name: "twitter:title", content: DOWNTOWN_BROOKLYN_CONDOS_TITLE },
  { property: "og:locale", content: "en_US" },
  { property: "og:type", content: "article" },
  { property: "og:title", content: DOWNTOWN_BROOKLYN_CONDOS_TITLE },
  { property: "og:description", content: DESCRIPTION },
  { property: "og:url", content: "https://montfortre.com/downtown-brooklyn-condos-2/" },
  { property: "og:site_name", content: "Montfort Real Estate" },
  { property: "og:image", content: "https://montfortre.com/redesign-assets/og/downtown-brooklyn.png" },
  { property: "article:publisher", content: "https://www.facebook.com/montfortrealestate" },
] as const;

export const DOWNTOWN_BROOKLYN_CONDOS_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/downtown-brooklyn-condos-2/" },
...
export const DOWNTOWN_BROOKLYN_CONDOS_JSON_LD = [
  ...
  '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"item":{"@id":"https://montfortre.com/","name":"Home"}},{"@type":"ListItem","position":2,"item":{"@id":"https://montfortre.com/downtown-brooklyn-condos-2/","name":"Downtown Brooklyn Condos"}}]}',
  ...
  '{"@context":"https://schema.org","@type":"WebPage","name":"Downtown Brooklyn Condos","description":"Downtown Brooklyn Condos \u2014 Expert Guidance for Condo Buyers, Sellers &amp; Investors We&#039;ll help you secure the right Downtown Brooklyn condo at the best possible value while avoiding costly surprises, building issues, and unfavorable purchase terms Call 1-(646)-970-1078 Schedule A Consultation \u2713SMOOTH TRANSACTIONWith limited risk throughout the buying process.\u2713NO PRESSURENo pressure to overpay or purchase within a specific timeframe.\u2713ONGOING SUPPORTA","inLanguage":"en-US","datePublished":"2026-05-19T06:24:00+00:00","dateModified":"2026-07-29T11:59:36+00:00","isPartOf":{"@type":"WebSite","name":"Montfort Real Estate","url":"https://montfortre.com/"}}',
] as const;

export const DOWNTOWN_BROOKLYN_CONDOS_SEO: PageSeo = {
  title: DOWNTOWN_BROOKLYN_CONDOS_TITLE,
  metas: DOWNTOWN_BROOKLYN_CONDOS_METAS,
  links: DOWNTOWN_BROOKLYN_CONDOS_LINKS,
  jsonLd: DOWNTOWN_BROOKLYN_CONDOS_JSON_LD,
};
