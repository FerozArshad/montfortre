/** Frozen SEO for /harlem/ — do not edit values. */

import type { PageSeo } from "../types";

export const HARLEM_TITLE = "Harlem | Montfort Real Estate";

export const HARLEM_METAS = [
  {
    "name": "description",
  ...
  {
    "name": "twitter:image",
    "content": "https://montfortre.com/redesign-assets/og/harlem.png"
  },
  {
    "property": "og:locale",
    "content": "en_US"
...
export const HARLEM_SEO: PageSeo = {
  title: HARLEM_TITLE,
  metas: HARLEM_METAS,
  links: HARLEM_LINKS,
  jsonLd: HARLEM_JSON_LD,
};
