/** Frozen SEO for /sitemap/ — copied from the live HTTrack capture. */

import type { PageSeo } from "../types";

const DESCRIPTION =
  "Browse the sitemap of Montfort Real Estate to explore all pages, listings, neighborhoods and resources across New York City real estate.";

export const SITE_MAP_TITLE = "Sitemap | Montfort Real Estate";

export const SITE_MAP_METAS = [
  { name: "description", content: DESCRIPTION },
  { property: "og:locale", content: "en_US" },
  { property: "og:type", content: "article" },
  { property: "og:title", content: "Sitemap | Montfort Real Estate" },
  { property: "og:description", content: DESCRIPTION },
  { property: "og:url", content: "https://montfortre.com/sitemap/" },
  ...
  { name: "twitter:title", content: "Sitemap | Montfort Real Estate" },
] as const;

export const SITE_MAP_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/sitemap/" },
...
export const SITE_MAP_JSON_LD = [
  ...
  '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"item":{"@id":"https://montfortre.com/","name":"Home"}},{"@type":"ListItem","position":2,"item":{"@id":"https://montfortre.com/sitemap/","name":"Sitemap"}}]}',
  ...
  '{"@context":"https://schema.org","@type":"WebPage","name":"Sitemap","description":"Sitemap Properties Pages Blog Bronx Neighborhoods Brooklyn Neighborhoods Current Listings Harlem Homes For Sale Harlem Listings Harlem Listings For Sale Home \\u2013 Team Home 2 Home Valuation Investment Criteria Luxury Brooklyn Brownstones Manhattan Neighborhoods Newsletter NYC Brownstones with Parking NYC Brownstones with Roof Deck Privacy Policy Queens Neighborhoods Sitemap Test Page Test Search Thank you The Definitive Guide On How","inLanguage":"en-US","datePublished":"2021-06-28T15:46:34+00:00","dateModified":"2026-03-31T14:44:23+00:00","isPartOf":{"@type":"WebSite","name":"Montfort Real Estate","url":"https://montfortre.com/"}}',
] as const;

export const SITE_MAP_SEO: PageSeo = {
  title: SITE_MAP_TITLE,
  metas: SITE_MAP_METAS,
  links: SITE_MAP_LINKS,
  jsonLd: SITE_MAP_JSON_LD,
};
