/** Frozen SEO for /upper-west-side-co-ops-2/ — do not edit values. */

import type { PageSeo } from "../types";

export const UPPER_WEST_SIDE_CO_OPS_TITLE = "Upper West Side co-ops | Montfort Real Estate";

const DESCRIPTION =
  "Explore Upper West Side co-ops with Montfort Real Estate. Discover luxury co-op apartments, historic residences, and investment opportunities on Manhattan's Upper West Side.";

export const UPPER_WEST_SIDE_CO_OPS_METAS = [
  { name: "description", content: DESCRIPTION },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:description", content: DESCRIPTION },
  { name: "twitter:image", content: "https://montfortre.com/redesign-assets/og/upper-west-side.png" },
  { name: "twitter:title", content: UPPER_WEST_SIDE_CO_OPS_TITLE },
  { property: "og:locale", content: "en_US" },
  { property: "og:type", content: "article" },
  { property: "og:title", content: UPPER_WEST_SIDE_CO_OPS_TITLE },
  { property: "og:description", content: DESCRIPTION },
  { property: "og:url", content: "https://montfortre.com/upper-west-side-co-ops-2/" },
  { property: "og:site_name", content: "Montfort Real Estate" },
  { property: "og:image", content: "https://montfortre.com/redesign-assets/og/upper-west-side.png" },
  { property: "article:publisher", content: "https://www.facebook.com/montfortrealestate" },
] as const;

export const UPPER_WEST_SIDE_CO_OPS_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/upper-west-side-co-ops-2/" },
...
export const UPPER_WEST_SIDE_CO_OPS_JSON_LD = [
  ...
  '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"item":{"@id":"https://montfortre.com/","name":"Home"}},{"@type":"ListItem","position":2,"item":{"@id":"https://montfortre.com/upper-west-side-co-ops-2/","name":"Upper West Side co-ops"}}]}',
  ...
  '{"@context":"https://schema.org","@type":"WebPage","name":"Upper West Side co-ops","description":"Upper West Side Co-Ops \u2014 Expert Guidance for Buyers, Sellers &amp; Investors We\u2019ll guide you through the Upper West Side co-op buying process, helping you navigate board requirements, financial reviews, and potential restrictions before you commit Call 1-(646)-970-1078 Schedule A Consultation \u2713SMOOTH TRANSACTIONWith limited risk throughout the buying process.\u2713NO PRESSURENo pressure to overpay or purchase within a specific timeframe.\u2713ONGOING SUPPORTA","inLanguage":"en-US","datePublished":"2026-05-19T06:14:38+00:00","dateModified":"2026-07-29T11:49:24+00:00","isPartOf":{"@type":"WebSite","name":"Montfort Real Estate","url":"https://montfortre.com/"}}',
] as const;

export const UPPER_WEST_SIDE_CO_OPS_SEO: PageSeo = {
  title: UPPER_WEST_SIDE_CO_OPS_TITLE,
  metas: UPPER_WEST_SIDE_CO_OPS_METAS,
  links: UPPER_WEST_SIDE_CO_OPS_LINKS,
  jsonLd: UPPER_WEST_SIDE_CO_OPS_JSON_LD,
};
