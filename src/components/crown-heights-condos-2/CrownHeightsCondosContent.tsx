...
export default function CrownHeightsCondosContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/migrated-live/Crown-Heights-Condos.png" alt="Crown Heights condos" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Crown Heights" propertyType="Condo" label="Crown Heights condos" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115395" />
      ...
      <PageContactSection topic="Crown Heights Condos" />
    </>
  );
}
