...
export default function MortgageCalculator() {
  ...
  const [downPayment, setDownPayment] = useState("400,000");
  const [downPaymentType, setDownPaymentType] = useState<AmountMode>("dollars");
      ...
      <div className="mc-inner">
        ...
        <div className="mc-grid">
          ...
          <div className="mc-results">
            ...
            <label className="mc-break-row">
              <span>Common charges / maintenance fees (per month)</span>
              <span className="mc-input-wrap">
                <span className="mc-prefix">$</span>
            ...
            <ToapRow
              label="Common charges / maintenance fees"
