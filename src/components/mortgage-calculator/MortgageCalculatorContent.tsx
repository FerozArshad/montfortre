...
import ChecklistLeadForm from "../shared/ChecklistLeadForm";
    ...
    <>
      <section className="tf-hero" data-screen-label="Service hero">
        ...
        <div className="tf-hero-inner">
          <div data-reveal="">
            <h1>NYC Mortgage Calculator — Plan Your Home Purchase with Confidence</h1>
            <p className="tf-hero-lead">
              Use our <b>NYC mortgage calculator</b> to understand your financing costs, plan ahead, and avoid surprises
          ...
          <div className="tf-hero-media" data-reveal="">
            <div className="tf-hero-frame">
              <img src="/redesign-assets/migrated-live/Mortgage-calculator.png" alt="NYC mortgage calculator" width="640" height="512" loading="eager" />
            </div>
      ...
      <section className="contact-section" data-screen-label="Checklist">
        <div className="contact-inner">
          <div data-reveal="" className="contact-copy">
            <ChecklistLeadForm
              resource="11 Costly Brownstone Mistakes checklist"
              fileUrl="https://assets.agentfire3.com/uploads/sites/312/2023/04/11-Costly-Brownstone-Mistakes.pdf"
              formType="mortgage-checklist"
            />
          </div>
