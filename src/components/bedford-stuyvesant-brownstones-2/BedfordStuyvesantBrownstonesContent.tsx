...
export default function BedfordStuyvesantBrownstonesContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/hoods/bedford-stuyvesant-brownstones.png" alt="Bedford-Stuyvesant brownstones" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Bedford-Stuyvesant" propertyType="Brownstone" label="Bedford-Stuyvesant brownstones" />
