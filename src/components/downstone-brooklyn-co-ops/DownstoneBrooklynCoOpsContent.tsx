...
import dtbkCoOpsGuide from "../../data/neighborhood-guides/downstone-brooklyn-co-ops.html?raw";
...
<PromisesBar variant="nbhd" />
      ...
      <PageListingsSection market="Downtown Brooklyn" propertyType="Co-op" label="Downtown Brooklyn co-ops" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115384" />
      ...
      <section className="nbhd-intro" data-screen-label="Heading">
        <div className="nbhd-intro-inner">
          <div className="nbhd-intro-copy" data-reveal="">
            <NeighborhoodGuideBody html={dtbkCoOpsGuide} />
          </div>
        </div>
      </section>
...
<section className="nbhd-intro" data-screen-label="Guide">
      ...
      <PageContactSection topic="Downstone Brooklyn Co Ops" />
    </>
  );
}
