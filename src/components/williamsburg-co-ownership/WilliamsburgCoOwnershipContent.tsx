...
export default function WilliamsburgCoOwnershipContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/hoods/williamsburg-coownership.png" alt="Williamsburg co-ownership homes" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Williamsburg" propertyType="Co-ownership" label="Williamsburg co-ownership homes" />
