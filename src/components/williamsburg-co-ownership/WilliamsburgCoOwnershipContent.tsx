...
import wburgCoOwnGuide from "../../data/neighborhood-guides/williamsburg-co-ownership.html?raw";
...
export default function WilliamsburgCoOwnershipContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/migrated-live/Williamsburg-Co-Ownership.png" alt="Williamsburg co-ownership homes" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Williamsburg" propertyType="Co-ownership" label="Williamsburg co-ownership homes" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115393" />
      ...
      <section className="nbhd-intro" data-screen-label="Guide">
        <div className="nbhd-intro-inner">
          <div className="nbhd-intro-copy" data-reveal="">
            <NeighborhoodGuideBody html={wburgCoOwnGuide} />
          </div>
        </div>
      </section>
      ...
      <PageContactSection topic="Williamsburg Co Ownership" />
    </>
  );
}
