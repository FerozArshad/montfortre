...
export default function ParkSlopeCoOwnershipContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/migrated-live/Coownership-buying.png" alt="Park Slope co-ownership homes" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Park Slope" propertyType="Co-ownership" label="Park Slope co-ownership homes" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115398" />
      ...
      <PageContactSection topic="Park Slope Coownership" />
    </>
  );
}
