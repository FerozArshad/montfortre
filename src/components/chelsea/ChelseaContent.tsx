...
import { CHELSEA_YELP_CATS } from "../../data/chelseaGuide";
import CHELSEA_SCHOOLS from "../../data/chelseaSchools.json";
import CHELSEA_YELP from "../../data/chelseaYelp.json";
...
type YelpCat = (typeof CHELSEA_YELP_CATS)[number]["id"];
...
export default function ChelseaContent() {
  ...
  const areaPlaces = (CHELSEA_YELP[areaCat] ?? []) as AreaPlace[];
  ...
  return (
    <>
      ...
      <section className="hlm-reviews" data-screen-label="Chelsea reviews">
      ...
      <HarlemSchools schools={CHELSEA_SCHOOLS as School[]} nearLabel="Chelsea" />
        ...
        <div className="hlm-area-inner">
          <div className="hlm-area-head" data-reveal="">
            <div className="hlm-area-head-copy">
              ...
              <p>Browse through the top rated businesses that Chelsea has to offer!</p>
            </div>
            {areaPlaces.length ? (
