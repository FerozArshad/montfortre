...
import wburgCondosGuide from "../../data/neighborhood-guides/williamsburg-condos.html?raw";
...
export default function WilliamsburgCondosContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/migrated-live/Williamsburg-Condos.png" alt="Williamsburg condos" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Williamsburg" propertyType="Condo" label="Williamsburg condos" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115392" />
      ...
      <section className="nbhd-intro" data-screen-label="Guide">
        <div className="nbhd-intro-inner">
          <div className="nbhd-intro-copy" data-reveal="">
            <NeighborhoodGuideBody html={wburgCondosGuide} />
          </div>
        </div>
      </section>
      ...
      <PageContactSection topic="Williamsburg Condos" />
    </>
  );
}
