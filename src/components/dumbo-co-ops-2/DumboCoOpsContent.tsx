...
export default function DumboCoOpsContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/hoods/dumbo-coops.png" alt="DUMBO co-op buildings" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="DUMBO" propertyType="Co-op" label="DUMBO co-ops" />
