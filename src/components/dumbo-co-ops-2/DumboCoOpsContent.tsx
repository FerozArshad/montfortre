...
import dumboCoOpsGuide from "../../data/neighborhood-guides/dumbo-co-ops-2.html?raw";
...
export default function DumboCoOpsContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/migrated-live/Dumbo-Co-ops.png" alt="DUMBO co-op buildings" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="DUMBO" propertyType="Co-op" label="DUMBO co-ops" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115386" />
      ...
      <section className="nbhd-intro" data-screen-label="Guide">
        <div className="nbhd-intro-inner">
          <div className="nbhd-intro-copy" data-reveal="">
            <NeighborhoodGuideBody html={dumboCoOpsGuide} />
          </div>
        </div>
      </section>
      ...
      <PageContactSection topic="Dumbo Co Ops" />
    </>
  );
}
