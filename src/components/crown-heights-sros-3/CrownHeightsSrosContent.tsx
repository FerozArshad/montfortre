...
export default function CrownHeightsSrosContent() {
  return (
    <>
      ...
      <PageListingsSection market="Crown Heights" propertyType="SRO" label="Crown Heights SROs" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115397" />
      ...
      <PageContactSection topic="Crown Heights SROs" />
    </>
  );
}
