...
import dumboCondosGuide from "../../data/neighborhood-guides/dumbo-condos.html?raw";
...
export default function DumboCondosContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/migrated-live/Dumbo-condo.png" alt="DUMBO condos" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="DUMBO" propertyType="Condo" label="DUMBO condos" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115385" />
      ...
      <section className="nbhd-intro" data-screen-label="Guide">
        <div className="nbhd-intro-inner">
          <div className="nbhd-intro-copy" data-reveal="">
            <NeighborhoodGuideBody html={dumboCondosGuide} />
          </div>
        </div>
      </section>
      ...
      <PageContactSection topic="Dumbo Condos" />
    </>
  );
}
