...
export default function UpperEastSideTownhousesContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/hoods/ues-townhouse.png" alt="Upper East Side townhouses" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Upper East Side" propertyType="Townhouse" label="Upper East Side townhouses" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115380" />
      ...
      <section className="nbhd-intro" data-screen-label="Guide">
        <div className="nbhd-intro-inner">
          <div className="nbhd-intro-copy" data-reveal="">
            <NeighborhoodGuideBody html={uesTownhousesGuide} />
          </div>
        </div>
      </section>
