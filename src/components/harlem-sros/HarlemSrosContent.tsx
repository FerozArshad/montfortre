...
export default function HarlemSrosContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/hoods/harlem-sros.png" alt="Harlem SRO buildings" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Harlem" propertyType="SRO" label="Harlem SROs" />
