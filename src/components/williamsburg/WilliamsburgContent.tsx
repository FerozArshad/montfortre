...
import { WILLIAMSBURG_YELP_CATS } from "../../data/williamsburgGuide";
import WILLIAMSBURG_SCHOOLS from "../../data/williamsburgSchools.json";
import WILLIAMSBURG_YELP from "../../data/williamsburgYelp.json";
...
type YelpCat = (typeof WILLIAMSBURG_YELP_CATS)[number]["id"];
...
export default function WilliamsburgContent() {
  ...
  const areaPlaces = (WILLIAMSBURG_YELP[areaCat] ?? []) as AreaPlace[];
  ...
  return (
    <>
      ...
      <section className="hlm-reviews" data-screen-label="Williamsburg reviews">
      ...
      <HarlemSchools schools={WILLIAMSBURG_SCHOOLS as School[]} nearLabel="Williamsburg" />
        ...
        <div className="hlm-area-inner">
          <div className="hlm-area-head" data-reveal="">
            <div className="hlm-area-head-copy">
              ...
              <p>Browse through the top rated businesses that Williamsburg has to offer!</p>
            </div>
            {areaPlaces.length ? (
          ...
          <div className="hlm-area-chips">
            {WILLIAMSBURG_YELP_CATS.map((cat) => (
              <button
                key={cat.id}
                type="button"
