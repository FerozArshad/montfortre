...
import chelseaCoOpsGuide from "../../data/neighborhood-guides/chelsea-co-ops-2.html?raw";
...
export default function ChelseaCoOpsContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/migrated-live/Chelsea-co-ops.png" alt="Chelsea co-op buildings" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Chelsea" propertyType="Co-op" label="Chelsea co-ops" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115383" />
      ...
      <section className="nbhd-intro" data-screen-label="Guide">
        <div className="nbhd-intro-inner">
          <div className="nbhd-intro-copy" data-reveal="">
            <NeighborhoodGuideBody html={chelseaCoOpsGuide} />
          </div>
        </div>
      </section>
      ...
      <PageContactSection topic="Chelsea Co Ops" />
    </>
  );
}
