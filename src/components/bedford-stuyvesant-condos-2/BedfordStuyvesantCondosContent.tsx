...
import bsCondosGuide from "../../data/neighborhood-guides/bedford-stuyvesant-condos-2.html?raw";
...
export default function BedfordStuyvesantCondosContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/hoods/bedford-stuyvesant-condos.png" alt="Bedford-Stuyvesant condos" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Bedford-Stuyvesant" propertyType="Condo" label="Bedford-Stuyvesant condos" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115391" />
      ...
      <section className="nbhd-intro" data-screen-label="Guide">
        <div className="nbhd-intro-inner">
          <div className="nbhd-intro-copy" data-reveal="">
            <NeighborhoodGuideBody html={bsCondosGuide} />
          </div>
        </div>
      </section>
      ...
      <PageContactSection topic="Bedford Stuyvesant Condos" />
    </>
  );
}
