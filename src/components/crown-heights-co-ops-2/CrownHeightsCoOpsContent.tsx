        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/migrated-live/Crown-Heights-Co-Ops.png" alt="Crown Heights co-op buildings" width="640" height="512" loading="eager" />
            </div>
...
<PromisesBar variant="nbhd" />
      ...
      <PageListingsSection market="Crown Heights" propertyType="Co-op" label="Crown Heights co-ops" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115396" />
      ...
      <PageContactSection topic="Crown Heights Co Ops" />
    </>
  );
}
