...
import bsCoOwnGuide from "../../data/neighborhood-guides/bedford-stuyvesant-co-ownership.html?raw";
...
export default function BedfordStuyvesantCoOwnershipContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/hoods/bedford-stuyvesant-coownership.png" alt="Bedford-Stuyvesant co-ownership homes" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Bedford-Stuyvesant" propertyType="Co-ownership" label="Bedford-Stuyvesant co-ownership homes" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115389" />
      ...
      <section className="nbhd-intro" data-screen-label="Guide">
        <div className="nbhd-intro-inner">
          <div className="nbhd-intro-copy" data-reveal="">
            <NeighborhoodGuideBody html={bsCoOwnGuide} />
          </div>
        </div>
      </section>
      ...
      <PageContactSection topic="Bedford Stuyvesant Co Ownership" />
    </>
  );
}
