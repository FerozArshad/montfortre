...
`App.tsx` must keep `<MobileHeader />` above `<Routes>` with the 138 migrated URLs in `src/App.tsx` plus `NotMigrated`.
...
| 2026-08-17 | Added three Williamsburg property pages and five Crown Heights property/guide pages (neighborhoods design system). |
| 2026-08-17 | Added five Park Slope property/guide pages (neighborhoods design system), preserving the owner-approved live-source anomalies. |
...
| 2026-08-17 | Added `/nyc-first-time-home-buyer-mortages/` (slug spelling preserved), `/nyc-brownstone-mortgages/`, and `/nyc-sro-mortgages/` (2-family buyer-guide chassis; preserved dual H1s and source hero contamination). |
