/** Frozen SEO for /williamsburg-co-ownership/ — do not edit values. */

import type { PageSeo } from "../types";

export const WILLIAMSBURG_CO_OWNERSHIP_TITLE = "Williamsburg Co-Ownership | Montfort Real Estate";

const DESCRIPTION =
  "Explore Williamsburg co-ownership opportunities with Montfort Real Estate. Learn about shared ownership, investment partnerships, and affordable property strategies in Williamsburg Brooklyn";

export const WILLIAMSBURG_CO_OWNERSHIP_METAS = [
  { name: "description", content: DESCRIPTION },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:description", content: DESCRIPTION },
  { name: "twitter:title", content: WILLIAMSBURG_CO_OWNERSHIP_TITLE },
  { property: "og:locale", content: "en_US" },
  { property: "og:type", content: "article" },
  { property: "og:title", content: WILLIAMSBURG_CO_OWNERSHIP_TITLE },
  { property: "og:description", content: DESCRIPTION },
  { property: "og:url", content: "https://montfortre.com/williamsburg-co-ownership/" },
...
export const WILLIAMSBURG_CO_OWNERSHIP_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/williamsburg-co-ownership/" },
...
export const WILLIAMSBURG_CO_OWNERSHIP_JSON_LD = [
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"item\":{\"@id\":\"https://montfortre.com/\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":2,\"item\":{\"@id\":\"https://montfortre.com/williamsburg-co-ownership/\",\"name\":\"Williamsburg Co-Ownership\"}}]}",
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"WebPage\",\"name\":\"Williamsburg Co-Ownership\",\"description\":\"Williamsburg Co-Ownership \\u2014 Buy, Sell &amp; Invest with Experts We\\u2019ll help you structure a successful Williamsburg co-ownership purchase by minimizing legal risks, protecting your investment, and ensuring the arrangement works for every owner Call 1-(646)-970-1078 Schedule A Consultation \\u2713SMOOTH TRANSACTIONWith limited risk throughout the buying process.\\u2713NO PRESSURENo pressure to overpay or purchase within a specific timeframe.\\u2713ONGOING SUPPORTA dedicated team that\",\"inLanguage\":\"en-US\",\"datePublished\":\"2026-05-19T06:40:05+00:00\",\"dateModified\":\"2026-07-29T13:00:21+00:00\",\"isPartOf\":{\"@type\":\"WebSite\",\"name\":\"Montfort Real Estate\",\"url\":\"https://montfortre.com/\"}}",
] as const;

export const WILLIAMSBURG_CO_OWNERSHIP_SEO: PageSeo = {
  title: WILLIAMSBURG_CO_OWNERSHIP_TITLE,
  metas: WILLIAMSBURG_CO_OWNERSHIP_METAS,
  links: WILLIAMSBURG_CO_OWNERSHIP_LINKS,
  jsonLd: WILLIAMSBURG_CO_OWNERSHIP_JSON_LD,
};
