/** Frozen SEO for /chelsea-co-ops-2/ — do not edit values. */

import type { PageSeo } from "../types";

export const CHELSEA_CO_OPS_TITLE = "Chelsea Co-Ops | Montfort Real Estate";

const DESCRIPTION =
  "Explore Chelsea co-ops with Montfort Real Estate. Discover luxury co-op apartments, historic residences, and investment opportunities in one of Manhattan’s most vibrant neighborhoods.";

export const CHELSEA_CO_OPS_METAS = [
  { name: "description", content: DESCRIPTION },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:description", content: DESCRIPTION },
  { name: "twitter:title", content: CHELSEA_CO_OPS_TITLE },
  { property: "og:locale", content: "en_US" },
  { property: "og:type", content: "article" },
  { property: "og:title", content: CHELSEA_CO_OPS_TITLE },
  { property: "og:description", content: DESCRIPTION },
  { property: "og:url", content: "https://montfortre.com/chelsea-co-ops-2/" },
...
export const CHELSEA_CO_OPS_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/chelsea-co-ops-2/" },
...
export const CHELSEA_CO_OPS_JSON_LD = [
  ...
  '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"item":{"@id":"https://montfortre.com/","name":"Home"}},{"@type":"ListItem","position":2,"item":{"@id":"https://montfortre.com/chelsea-co-ops-2/","name":"Chelsea Co-Ops"}}]}',
  ...
  '{"@context":"https://schema.org","@type":"WebPage","name":"Chelsea Co-Ops","description":"Chelsea Co-Ops \u2014 Expert Guidance for Buyers, Sellers &amp; Investors We&#039;ll guide you through the Chelsea co-op buying process by evaluating financial statements, board requirements, and building health to help you make a secure and informed purchase Call 1-(646)-970-1078 Schedule A Consultation \u2713SMOOTH TRANSACTIONWith limited risk throughout the buying process.\u2713NO PRESSURENo pressure to overpay or purchase within a specific timeframe.\u2713ONGOING","inLanguage":"en-US","datePublished":"2026-05-19T06:21:57+00:00","dateModified":"2026-07-29T11:58:33+00:00","isPartOf":{"@type":"WebSite","name":"Montfort Real Estate","url":"https://montfortre.com/"}}',
] as const;

export const CHELSEA_CO_OPS_SEO: PageSeo = {
  title: CHELSEA_CO_OPS_TITLE,
  metas: CHELSEA_CO_OPS_METAS,
  links: CHELSEA_CO_OPS_LINKS,
  jsonLd: CHELSEA_CO_OPS_JSON_LD,
};
