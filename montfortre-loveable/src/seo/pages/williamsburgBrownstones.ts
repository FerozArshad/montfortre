/** Frozen SEO for /williamsburg-brownstones-2/ — do not edit values. */

import type { PageSeo } from "../types";

export const WILLIAMSBURG_BROWNSTONES_TITLE = "Williamsburg Brownstones | Montfort Real Estate";

const DESCRIPTION =
  "Explore Williamsburg brownstones with Montfort Real Estate. Discover historic Brooklyn brownstones, luxury townhomes, and investment opportunities in Williamsburg NYC";

export const WILLIAMSBURG_BROWNSTONES_METAS = [
  { name: "description", content: DESCRIPTION },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:description", content: DESCRIPTION },
  { name: "twitter:title", content: WILLIAMSBURG_BROWNSTONES_TITLE },
  { property: "og:locale", content: "en_US" },
  { property: "og:type", content: "article" },
  { property: "og:title", content: WILLIAMSBURG_BROWNSTONES_TITLE },
  { property: "og:description", content: DESCRIPTION },
  { property: "og:url", content: "https://montfortre.com/williamsburg-brownstones-2/" },
...
export const WILLIAMSBURG_BROWNSTONES_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/williamsburg-brownstones-2/" },
...
export const WILLIAMSBURG_BROWNSTONES_JSON_LD = [
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"item\":{\"@id\":\"https://montfortre.com/\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":2,\"item\":{\"@id\":\"https://montfortre.com/williamsburg-brownstones-2/\",\"name\":\"Williamsburg Brownstones\"}}]}",
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"WebPage\",\"name\":\"Williamsburg Brownstones\",\"description\":\"Williamsburg Brownstones \\u2014 Expert Guidance for Buyers, Sellers &amp; Investors We\\u2019ll help you purchase the right Williamsburg brownstone by avoiding costly structural issues, hidden repairs, and overpaying in one of Brooklyn\\u2019s most competitive markets. Call 1-(646)-970-1078 Schedule A Consultation \\u2713SMOOTH TRANSACTIONWith limited risk throughout the buying process.\\u2713NO PRESSURENo pressure to overpay or purchase within a specific timeframe.\\u2713ONGOING SUPPORTA dedicated team\",\"inLanguage\":\"en-US\",\"datePublished\":\"2026-05-19T06:37:36+00:00\",\"dateModified\":\"2026-07-29T12:54:19+00:00\",\"isPartOf\":{\"@type\":\"WebSite\",\"name\":\"Montfort Real Estate\",\"url\":\"https://montfortre.com/\"}}",
] as const;

export const WILLIAMSBURG_BROWNSTONES_SEO: PageSeo = {
  title: WILLIAMSBURG_BROWNSTONES_TITLE,
  metas: WILLIAMSBURG_BROWNSTONES_METAS,
  links: WILLIAMSBURG_BROWNSTONES_LINKS,
  jsonLd: WILLIAMSBURG_BROWNSTONES_JSON_LD,
};
