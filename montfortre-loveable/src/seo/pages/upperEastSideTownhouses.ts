/** Frozen SEO for /upper-east-side-townhouses/ — do not edit values. */

import type { PageSeo } from "../types";

export const UPPER_EAST_SIDE_TOWNHOUSES_TITLE = "Upper East Side Townhouses | Montfort Real Estate";

const DESCRIPTION =
  "Explore Upper East Side townhouses with Montfort Real Estate. Discover luxury townhomes, historic brownstones, and investment opportunities in one of Manhattan’s most prestigious neighborhoods.";

export const UPPER_EAST_SIDE_TOWNHOUSES_METAS = [
  { name: "description", content: DESCRIPTION },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:description", content: DESCRIPTION },
  { name: "twitter:image", content: "https://montfortre.com/redesign-assets/og/upper-east-side.png" },
  { name: "twitter:title", content: UPPER_EAST_SIDE_TOWNHOUSES_TITLE },
  { property: "og:locale", content: "en_US" },
  { property: "og:type", content: "article" },
  { property: "og:title", content: UPPER_EAST_SIDE_TOWNHOUSES_TITLE },
  { property: "og:description", content: DESCRIPTION },
  { property: "og:url", content: "https://montfortre.com/upper-east-side-townhouses/" },
  { property: "og:site_name", content: "Montfort Real Estate" },
  { property: "og:image", content: "https://montfortre.com/redesign-assets/og/upper-east-side.png" },
  { property: "article:publisher", content: "https://www.facebook.com/montfortrealestate" },
] as const;

export const UPPER_EAST_SIDE_TOWNHOUSES_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/upper-east-side-townhouses/" },
...
export const UPPER_EAST_SIDE_TOWNHOUSES_JSON_LD = [
  ...
  '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"item":{"@id":"https://montfortre.com/","name":"Home"}},{"@type":"ListItem","position":2,"item":{"@id":"https://montfortre.com/upper-east-side-townhouses/","name":"Upper East Side Townhouses"}}]}',
  ...
  '{"@context":"https://schema.org","@type":"WebPage","name":"Upper East Side Townhouses","description":"Upper East Side Townhouses \u2014 Expert Guidance for Buyers, Sellers &amp; Investors We\u2019ll help you purchase the right Upper East Side townhouse by identifying hidden maintenance concerns, evaluating long-term ownership costs, and ensuring you make a confident investment Call 1-(646)-970-1078 Schedule A Consultation \u2713SMOOTH TRANSACTIONWith limited risk throughout the buying process.\u2713NO PRESSURENo pressure to overpay or purchase within a specific","inLanguage":"en-US","datePublished":"2026-05-19T06:15:53+00:00","dateModified":"2026-07-29T11:50:22+00:00","isPartOf":{"@type":"WebSite","name":"Montfort Real Estate","url":"https://montfortre.com/"}}',
] as const;

export const UPPER_EAST_SIDE_TOWNHOUSES_SEO: PageSeo = {
  title: UPPER_EAST_SIDE_TOWNHOUSES_TITLE,
  metas: UPPER_EAST_SIDE_TOWNHOUSES_METAS,
  links: UPPER_EAST_SIDE_TOWNHOUSES_LINKS,
  jsonLd: UPPER_EAST_SIDE_TOWNHOUSES_JSON_LD,
};
