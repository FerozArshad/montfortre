/** Frozen SEO for /crown-heights-sros-3/ — do not edit values. */

import type { PageSeo } from "../types";

export const CROWN_HEIGHTS_SROS_TITLE = "Crown Heights SROs | Montfort Real Estate";

const DESCRIPTION =
  "Explore Crown Heights SRO properties with Montfort Real Estate. Learn about Single Room Occupancy investments, financing, and multifamily opportunities in Crown Heights Brooklyn";

export const CROWN_HEIGHTS_SROS_METAS = [
  { name: "description", content: DESCRIPTION },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:description", content: DESCRIPTION },
  { name: "twitter:image", content: "https://montfortre.com/redesign-assets/og/crown-heights.png" },
  { name: "twitter:title", content: CROWN_HEIGHTS_SROS_TITLE },
  { property: "og:locale", content: "en_US" },
  { property: "og:type", content: "article" },
  { property: "og:title", content: CROWN_HEIGHTS_SROS_TITLE },
  { property: "og:description", content: DESCRIPTION },
  { property: "og:url", content: "https://montfortre.com/crown-heights-sros-3/" },
...
export const CROWN_HEIGHTS_SROS_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/crown-heights-sros-3/" },
...
export const CROWN_HEIGHTS_SROS_JSON_LD = [
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"item\":{\"@id\":\"https://montfortre.com/\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":2,\"item\":{\"@id\":\"https://montfortre.com/crown-heights-sros-3/\",\"name\":\"Crown Heights SROs\"}}]}",
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"WebPage\",\"name\":\"Crown Heights SROs\",\"description\":\"Crown Heights SROs \\u2014 Expert Guidance for Buyers, Sellers &amp; Investors We&#039;ll help you invest in the right Crown Heights SRO by identifying properties with strong potential while avoiding compliance, maintenance, and violation issues. Call 1-(646)-970-1078 Schedule A Consultation \\u2713SMOOTH TRANSACTIONWith limited risk throughout the buying process.\\u2713NO PRESSURENo pressure to overpay or purchase within a specific timeframe.\\u2713ONGOING SUPPORTA dedicated team\",\"inLanguage\":\"en-US\",\"datePublished\":\"2026-05-19T06:47:15+00:00\",\"dateModified\":\"2026-07-29T13:02:29+00:00\",\"isPartOf\":{\"@type\":\"WebSite\",\"name\":\"Montfort Real Estate\",\"url\":\"https://montfortre.com/\"}}",
] as const;

export const CROWN_HEIGHTS_SROS_SEO: PageSeo = {
  title: CROWN_HEIGHTS_SROS_TITLE,
  metas: CROWN_HEIGHTS_SROS_METAS,
  links: CROWN_HEIGHTS_SROS_LINKS,
  jsonLd: CROWN_HEIGHTS_SROS_JSON_LD,
};
