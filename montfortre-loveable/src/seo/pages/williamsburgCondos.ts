/** Frozen SEO for /williamsburg-condos/ — do not edit values. */

import type { PageSeo } from "../types";

export const WILLIAMSBURG_CONDOS_TITLE = "Williamsburg Condos | Montfort Real Estate";

const DESCRIPTION =
  "Explore Williamsburg condos with Montfort Real Estate. Discover luxury condos, waterfront residences, and investment opportunities in one of Brooklyn’s most sought-after neighborhoods";

export const WILLIAMSBURG_CONDOS_METAS = [
  { name: "description", content: DESCRIPTION },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:description", content: DESCRIPTION },
  { name: "twitter:title", content: WILLIAMSBURG_CONDOS_TITLE },
  { property: "og:locale", content: "en_US" },
  { property: "og:type", content: "article" },
  { property: "og:title", content: WILLIAMSBURG_CONDOS_TITLE },
  { property: "og:description", content: DESCRIPTION },
  { property: "og:url", content: "https://montfortre.com/williamsburg-condos/" },
...
export const WILLIAMSBURG_CONDOS_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/williamsburg-condos/" },
...
export const WILLIAMSBURG_CONDOS_JSON_LD = [
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"item\":{\"@id\":\"https://montfortre.com/\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":2,\"item\":{\"@id\":\"https://montfortre.com/williamsburg-condos/\",\"name\":\"Williamsburg Condos\"}}]}",
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"WebPage\",\"name\":\"Williamsburg Condos\",\"description\":\"Williamsburg Condos \\u2014 Expert Guidance for Buyers, Sellers &amp; Investors We\\u2019ll help you make a smart Williamsburg condo purchase by avoiding overpriced listings, unexpected costs, and choosing a property that fits your long-term goals Call 1-(646)-970-1078 Schedule A Consultation \\u2713SMOOTH TRANSACTIONWith limited risk throughout the buying process.\\u2713NO PRESSURENo pressure to overpay or purchase within a specific timeframe.\\u2713ONGOING SUPPORTA dedicated team\",\"inLanguage\":\"en-US\",\"datePublished\":\"2026-05-19T06:38:19+00:00\",\"dateModified\":\"2026-07-29T12:55:01+00:00\",\"isPartOf\":{\"@type\":\"WebSite\",\"name\":\"Montfort Real Estate\",\"url\":\"https://montfortre.com/\"}}",
] as const;

export const WILLIAMSBURG_CONDOS_SEO: PageSeo = {
  title: WILLIAMSBURG_CONDOS_TITLE,
  metas: WILLIAMSBURG_CONDOS_METAS,
  links: WILLIAMSBURG_CONDOS_LINKS,
  jsonLd: WILLIAMSBURG_CONDOS_JSON_LD,
};
