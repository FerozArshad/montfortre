/** Frozen SEO for /park-slope-coops/ — do not edit values. */

import type { PageSeo } from "../types";

export const PARK_SLOPE_CO_OPS_TITLE = "Park Slope Coops | Montfort Real Estate";

export const PARK_SLOPE_CO_OPS_METAS = [
  ...
  { property: "og:title", content: PARK_SLOPE_CO_OPS_TITLE },
...
export const PARK_SLOPE_CO_OPS_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/park-slope-coops/" },
...
export const PARK_SLOPE_CO_OPS_JSON_LD = [
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"@id\":\"https://montfortre.com/park-slope-coops/#breadcrumb\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"Home\",\"item\":\"https://montfortre.com/\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"Park Slope\",\"item\":\"https://montfortre.com/park-slope/\"},{\"@type\":\"ListItem\",\"position\":3,\"name\":\"Park Slope Co-op Realtor\",\"item\":\"https://montfortre.com/park-slope-coops/\"}]}",
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"item\":{\"@id\":\"https://montfortre.com/\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":2,\"item\":{\"@id\":\"https://montfortre.com/park-slope-coops/\",\"name\":\"Park Slope Coops\"}}]}",
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"WebPage\",\"name\":\"Park Slope Coops\",\"description\":\"Park Slope Co-ops — Experts realtor for Buying, Selling &amp; Investing We&#039;ll help you buy the right Park Slope Condo by avoiding costly structural issues, hidden repair expenses, and overpaying in a competitive market Call 1-(646)-970-1078 Schedule A Consultation ✓SMOOTH TRANSACTIONWith limited risk throughout the buying process.✓NO PRESSURENo pressure to overpay or purchase within a specific timeframe.✓ONGOING SUPPORTA dedicated team\",\"inLanguage\":\"en-US\",\"datePublished\":\"2026-08-06T19:50:40+00:00\",\"dateModified\":\"2026-08-07T00:20:57+00:00\",\"isPartOf\":{\"@type\":\"WebSite\",\"name\":\"Montfort Real Estate\",\"url\":\"https://montfortre.com/\"}}",
] as const;

export const PARK_SLOPE_CO_OPS_SEO: PageSeo = {
  title: PARK_SLOPE_CO_OPS_TITLE,
  metas: PARK_SLOPE_CO_OPS_METAS,
  links: PARK_SLOPE_CO_OPS_LINKS,
  jsonLd: PARK_SLOPE_CO_OPS_JSON_LD,
};
