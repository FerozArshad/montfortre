/** Frozen SEO for /brooklyn-heights-co-ops-3/ — do not edit values. */

import type { PageSeo } from "../types";

export const BROOKLYN_HEIGHTS_CO_OPS_TITLE = "Brooklyn Heights Co-Ops | Montfort Real Estate";

const DESCRIPTION =
  "Explore Brooklyn Heights co-ops with Montfort Real Estate. Discover historic co-op apartments, luxury residences, and investment opportunities in one of Brooklyn’s most prestigious neighborhoods.";

export const BROOKLYN_HEIGHTS_CO_OPS_METAS = [
  { name: "description", content: DESCRIPTION },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:description", content: DESCRIPTION },
  { name: "twitter:image", content: "https://montfortre.com/redesign-assets/og/brooklyn-heights.png" },
  { name: "twitter:title", content: BROOKLYN_HEIGHTS_CO_OPS_TITLE },
  { property: "og:locale", content: "en_US" },
  { property: "og:type", content: "article" },
  { property: "og:title", content: BROOKLYN_HEIGHTS_CO_OPS_TITLE },
  { property: "og:description", content: DESCRIPTION },
  { property: "og:url", content: "https://montfortre.com/brooklyn-heights-co-ops-3/" },
...
export const BROOKLYN_HEIGHTS_CO_OPS_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/brooklyn-heights-co-ops-3/" },
...
export const BROOKLYN_HEIGHTS_CO_OPS_JSON_LD = [
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"item\":{\"@id\":\"https://montfortre.com/\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":2,\"item\":{\"@id\":\"https://montfortre.com/brooklyn-heights-co-ops-3/\",\"name\":\"Brooklyn Heights Co-Ops\"}}]}",
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"WebPage\",\"name\":\"Brooklyn Heights Co-Ops\",\"description\":\"Brooklyn Heights Co-Ops \\u2014 Expert Guidance for Buyers, Sellers &amp; Investors We\\u2019ll guide you through the Brooklyn Heights co-op buying process, helping you navigate board requirements, avoid costly mistakes, and secure the right home with confidence Call 1-(646)-970-1078 Schedule A Consultation \\u2713SMOOTH TRANSACTIONWith limited risk throughout the buying process.\\u2713NO PRESSURENo pressure to overpay or purchase within a specific timeframe.\\u2713ONGOING SUPPORTA\",\"inLanguage\":\"en-US\",\"datePublished\":\"2026-05-19T06:31:33+00:00\",\"dateModified\":\"2026-07-29T12:34:55+00:00\",\"isPartOf\":{\"@type\":\"WebSite\",\"name\":\"Montfort Real Estate\",\"url\":\"https://montfortre.com/\"}}",
] as const;

export const BROOKLYN_HEIGHTS_CO_OPS_SEO: PageSeo = {
  title: BROOKLYN_HEIGHTS_CO_OPS_TITLE,
  metas: BROOKLYN_HEIGHTS_CO_OPS_METAS,
  links: BROOKLYN_HEIGHTS_CO_OPS_LINKS,
  jsonLd: BROOKLYN_HEIGHTS_CO_OPS_JSON_LD,
};
