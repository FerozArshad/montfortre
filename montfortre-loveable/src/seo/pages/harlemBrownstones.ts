/** Frozen SEO for /harlem-brownstones/ — do not edit values. */

import type { PageSeo } from "../types";

export const HARLEM_BROWNSTONES_TITLE = "Harlem Brownstones | Montfort Real Estate";

const DESCRIPTION =
  "Explore Harlem brownstones for sale and investment opportunities with Montfort Real Estate. Get expert guidance on buying, selling, and valuing historic brownstones in Harlem NYC.";

export const HARLEM_BROWNSTONES_METAS = [
  { name: "description", content: DESCRIPTION },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:description", content: DESCRIPTION },
  { name: "twitter:title", content: HARLEM_BROWNSTONES_TITLE },
  { property: "og:locale", content: "en_US" },
  { property: "og:type", content: "article" },
  { property: "og:title", content: HARLEM_BROWNSTONES_TITLE },
  { property: "og:description", content: DESCRIPTION },
  { property: "og:url", content: "https://montfortre.com/harlem-brownstones/" },
...
export const HARLEM_BROWNSTONES_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/harlem-brownstones/" },
...
export const HARLEM_BROWNSTONES_JSON_LD = [
  ...
  '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"item":{"@id":"https://montfortre.com/","name":"Home"}},{"@type":"ListItem","position":2,"item":{"@id":"https://montfortre.com/harlem-brownstones/","name":"Harlem Brownstones"}}]}',
  ...
  '{"@context":"https://schema.org","@type":"WebPage","name":"Harlem Brownstones","description":"Harlem Brownstones \u2014 Expert Guidance for Buyers, Sellers &amp; Investors We\u2019ll help you purchase the right Harlem brownstone while avoiding costly renovation surprises, structural issues, and unnecessary risks Call 1-(646)-970-1078 Schedule A Consultation \u2713SMOOTH TRANSACTIONWith limited risk throughout the buying process.\u2713NO PRESSURENo pressure to overpay or purchase within a specific timeframe.\u2713ONGOING SUPPORTA dedicated team that remains available even after the","inLanguage":"en-US","datePublished":"2026-05-19T06:03:34+00:00","dateModified":"2026-07-29T09:44:52+00:00","isPartOf":{"@type":"WebSite","name":"Montfort Real Estate","url":"https://montfortre.com/"}}',
] as const;

export const HARLEM_BROWNSTONES_SEO: PageSeo = {
  title: HARLEM_BROWNSTONES_TITLE,
  metas: HARLEM_BROWNSTONES_METAS,
  links: HARLEM_BROWNSTONES_LINKS,
  jsonLd: HARLEM_BROWNSTONES_JSON_LD,
};
