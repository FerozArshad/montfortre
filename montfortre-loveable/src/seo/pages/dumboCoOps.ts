/** Frozen SEO for /dumbo-co-ops-2/ — do not edit values. */

import type { PageSeo } from "../types";

export const DUMBO_CO_OPS_TITLE = "Dumbo Co-Ops | Montfort Real Estate";

const DESCRIPTION =
  "Explore DUMBO co-ops with Montfort Real Estate. Discover co-op apartments, loft-style residences, and investment opportunities in one of Brooklyn’s most iconic waterfront neighborhoods.";

export const DUMBO_CO_OPS_METAS = [
  { name: "description", content: DESCRIPTION },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:description", content: DESCRIPTION },
  { name: "twitter:image", content: "https://montfortre.com/redesign-assets/og/dumbo.png" },
  { name: "twitter:title", content: DUMBO_CO_OPS_TITLE },
  { property: "og:locale", content: "en_US" },
  { property: "og:type", content: "article" },
  { property: "og:title", content: DUMBO_CO_OPS_TITLE },
  { property: "og:description", content: DESCRIPTION },
  { property: "og:url", content: "https://montfortre.com/dumbo-co-ops-2/" },
  { property: "og:site_name", content: "Montfort Real Estate" },
  { property: "og:image", content: "https://montfortre.com/redesign-assets/og/dumbo.png" },
  { property: "article:publisher", content: "https://www.facebook.com/montfortrealestate" },
] as const;

export const DUMBO_CO_OPS_LINKS = [
  { rel: "canonical", href: "https://montfortre.com/dumbo-co-ops-2/" },
...
export const DUMBO_CO_OPS_JSON_LD = [
  ...
  '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"item":{"@id":"https://montfortre.com/","name":"Home"}},{"@type":"ListItem","position":2,"item":{"@id":"https://montfortre.com/dumbo-co-ops-2/","name":"Dumbo Co-Ops"}}]}',
  ...
  '{"@context":"https://schema.org","@type":"WebPage","name":"Dumbo Co-Ops","description":"Dumbo Co-Ops \u2014 Expert Guidance for Buyers, Sellers &amp; Investors We&#039;ll help you navigate the co-op buying process with confidence by evaluating building financials, board requirements, and hidden costs so you can make a smart and secure purchase Call 1-(646)-970-1078 Schedule A Consultation \u2713SMOOTH TRANSACTIONWith limited risk throughout the buying process.\u2713NO PRESSURENo pressure to overpay or purchase within a specific","inLanguage":"en-US","datePublished":"2026-05-19T06:27:57+00:00","dateModified":"2026-07-29T12:07:27+00:00","isPartOf":{"@type":"WebSite","name":"Montfort Real Estate","url":"https://montfortre.com/"}}',
] as const;

export const DUMBO_CO_OPS_SEO: PageSeo = {
  title: DUMBO_CO_OPS_TITLE,
  metas: DUMBO_CO_OPS_METAS,
  links: DUMBO_CO_OPS_LINKS,
  jsonLd: DUMBO_CO_OPS_JSON_LD,
};
