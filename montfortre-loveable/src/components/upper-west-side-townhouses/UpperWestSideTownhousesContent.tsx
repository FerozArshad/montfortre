...
export default function UpperWestSideTownhousesContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/hoods/uws-townhouse.jpg" alt="Upper West Side townhouses" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Upper West Side" propertyType="Townhouse" label="Upper West Side townhouses" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115376" />
      ...
      <section className="nbhd-intro" data-screen-label="Guide">
        <div className="nbhd-intro-inner">
          <div className="nbhd-intro-copy" data-reveal="">
            <NeighborhoodGuideBody html={uwsTownhousesGuide} />
          </div>
        </div>
      </section>
