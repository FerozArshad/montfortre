...
import uwsCoOpsGuide from "../../data/neighborhood-guides/upper-west-side-co-ops-2.html?raw";
...
export default function UpperWestSideCoOpsContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/hoods/uws-coops.png" alt="Upper West Side co-op buildings" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Upper West Side" propertyType="Co-op" label="Upper West Side co-ops" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115378" />
      ...
      <section className="nbhd-intro" data-screen-label="Guide">
        <div className="nbhd-intro-inner">
          <div className="nbhd-intro-copy" data-reveal="">
            <NeighborhoodGuideBody html={uwsCoOpsGuide} />
          </div>
        </div>
      </section>
      ...
      <PageContactSection topic="Upper West Side Co Ops" />
    </>
  );
}
