...
import uwsCondosGuide from "../../data/neighborhood-guides/upper-west-side-condos.html?raw";
...
export default function UpperWestSideCondosContent() {
  return (
    <>
      ...
      <PageListingsSection market="Upper West Side" propertyType="Condo" label="Upper West Side condos" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115377" />
      ...
      <section className="nbhd-intro" data-screen-label="Guide">
        <div className="nbhd-intro-inner">
          <div className="nbhd-intro-copy" data-reveal="">
            <NeighborhoodGuideBody html={uwsCondosGuide} />
          </div>
        </div>
      </section>
      ...
      <PageContactSection topic="Upper West Side Condos" />
    </>
  );
}
