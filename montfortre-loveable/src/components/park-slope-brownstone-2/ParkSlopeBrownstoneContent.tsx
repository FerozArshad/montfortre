...
export default function ParkSlopeBrownstoneContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/migrated-live/Park-Slope-Brownstone.png" alt="Park Slope brownstones" width="640" height="512" loading="eager" className="nbhd-hero-photo" />
            </div>
      ...
      <PageListingsSection market="Park Slope" propertyType="Brownstone" label="Park Slope brownstones" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115398" />
