...
import "../../styles/williamsburg-co-ops-page.css";
...
import wburgCoOpsGuide from "../../data/neighborhood-guides/williamsburg-co-ops.html?raw";
...
export default function WilliamsburgCoOpsContent() {
  return (
    <>
      <section className="nbhd-hero" data-screen-label="Service hero">
        ...
        <div className="nbhd-hero-inner">
          <div data-reveal="">
            <h1>Williamsburg Co-Ops — Expert Guidance for Buyers, Sellers & Investors</h1>
            <p className="nbhd-hero-lead">
              We'll guide you through the Williamsburg co-op buying process, helping you avoid board approval issues,
              restrictive policies, and costly financial mistakes
            </p>
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img
                src="/redesign-assets/migrated-live/Williamsburg-Co-Ops.png"
                alt="Williamsburg co-op buildings"
                width="640"
                height="512"
                loading="eager"
      ...
      <PageListingsSection
        market="Williamsburg"
        propertyType="Co-op"
        label="Williamsburg co-ops"
        idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115394"
      />
      ...
      <section className="nbhd-intro" data-screen-label="Guide">
        <div className="nbhd-intro-inner">
          <div className="nbhd-intro-copy" data-reveal="">
            <NeighborhoodGuideBody html={wburgCoOpsGuide} />
          </div>
        </div>
      </section>
      ...
      <PageContactSection topic="Williamsburg Co Ops" />
    </>
  );
}
