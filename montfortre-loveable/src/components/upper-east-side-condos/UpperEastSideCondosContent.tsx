...
import uesCondosGuide from "../../data/neighborhood-guides/upper-east-side-condos.html?raw";
...
export default function UpperEastSideCondosContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/hoods/ues-condo.png" alt="Upper East Side condos" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Upper East Side" propertyType="Condo" label="Upper East Side condos" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115379" />
      ...
      <section className="nbhd-intro" data-screen-label="Guide">
        <div className="nbhd-intro-inner">
          <div className="nbhd-intro-copy" data-reveal="">
            <NeighborhoodGuideBody html={uesCondosGuide} />
          </div>
        </div>
      </section>
      ...
      <PageContactSection topic="Upper East Side Condos" />
    </>
  );
}
