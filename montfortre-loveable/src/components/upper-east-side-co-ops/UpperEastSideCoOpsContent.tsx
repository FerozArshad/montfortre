...
import uesCoOpsGuide from "../../data/neighborhood-guides/upper-east-side-co-ops.html?raw";
...
export default function UpperEastSideCoOpsContent() {
  return (
    <>
      ...
      <PageListingsSection market="Upper East Side" propertyType="Co-op" label="Upper East Side co-ops" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#89206" />
      ...
      <section className="nbhd-intro" data-screen-label="Guide">
        <div className="nbhd-intro-inner">
          <div className="nbhd-intro-copy" data-reveal="">
            <NeighborhoodGuideBody html={uesCoOpsGuide} />
          </div>
        </div>
      </section>
      ...
      <PageContactSection topic="Upper East Side Co Ops" />
    </>
  );
}
