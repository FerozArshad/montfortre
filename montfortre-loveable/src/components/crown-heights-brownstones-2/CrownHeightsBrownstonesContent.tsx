...
export default function CrownHeightsBrownstonesContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/migrated-live/Crown-Heights-Brownstones.png" alt="Crown Heights brownstones" width="640" height="512" loading="eager" className="nbhd-hero-photo" />
            </div>
      ...
      <PageListingsSection market="Crown Heights" propertyType="Brownstone" label="Crown Heights brownstones" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115397" />
