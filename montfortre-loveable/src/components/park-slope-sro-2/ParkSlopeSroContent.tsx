...
export default function ParkSlopeSroContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/migrated-live/Park-Slope-purshace-documents.png" alt="Park Slope SRO buildings" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Park Slope" propertyType="SRO" label="Park Slope SROs" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115398" />
      ...
      <PageContactSection topic="Park Slope Sro" />
    </>
  );
}
