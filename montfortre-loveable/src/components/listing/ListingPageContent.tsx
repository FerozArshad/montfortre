          ...
          <div className="listing-modal-card" onClick={(e) => e.stopPropagation()}>
            ...
            <form
              ...
              onSubmit={(e) => {
                ...
                if (!days || !times) {
                  setTourError("Please pick at least one preferred day and time.");
                  return;
                }
                ...
                void (async () => {
                  ...
                  try {
                    ...
                    turnstile.resetTurnstile();
                    setTourError(err instanceof Error ? err.message : "Could not submit tour request");
                  } finally {
                    setTourBusy(false);
                  }
                })();
            ...
            >
              ...
              <label className="listing-field">
                ...
                <textarea name="comments" rows={3} placeholder="Tell us what you'd like to see or any timing notes" />
              </label>
              ...
              <button
                type="submit"
                className="listing-btn listing-btn--gold listing-btn--block"
                disabled={tourBusy || (turnstile.required && !turnstile.token)}
              >
