...
import bsCoOpsGuide from "../../data/neighborhood-guides/bedford-stuyvesant-co-ops-2.html?raw";
...
export default function BedfordStuyvesantCoOpsContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/hoods/bedford-stuyvesant-coops.png" alt="Bedford-Stuyvesant co-op buildings" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Bedford-Stuyvesant" propertyType="Co-op" label="Bedford-Stuyvesant co-ops" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115390" />
      ...
      <section className="nbhd-intro" data-screen-label="Guide">
        <div className="nbhd-intro-inner">
          <div className="nbhd-intro-copy" data-reveal="">
            <NeighborhoodGuideBody html={bsCoOpsGuide} />
          </div>
        </div>
      </section>
      ...
      <PageContactSection topic="Bedford Stuyvesant Co Ops" />
    </>
  );
}
