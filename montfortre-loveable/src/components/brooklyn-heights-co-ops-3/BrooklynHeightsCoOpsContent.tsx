...
import bhCoOpsGuide from "../../data/neighborhood-guides/brooklyn-heights-co-ops-3.html?raw";
...
export default function BrooklynHeightsCoOpsContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/hoods/brooklyn-heights-coops.png" alt="Brooklyn Heights co-op buildings" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Brooklyn Heights" propertyType="Co-op" label="Brooklyn Heights co-ops" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115387" />
      ...
      <section className="nbhd-intro" data-screen-label="Guide">
        <div className="nbhd-intro-inner">
          <div className="nbhd-intro-copy" data-reveal="">
            <NeighborhoodGuideBody html={bhCoOpsGuide} />
          </div>
        </div>
      </section>
      ...
      <PageContactSection topic="Brooklyn Heights Co Ops" />
    </>
  );
}
