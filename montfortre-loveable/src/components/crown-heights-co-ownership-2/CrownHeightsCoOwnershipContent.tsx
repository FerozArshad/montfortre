...
export default function CrownHeightsCoOwnershipContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/migrated-live/Crown-Heights-Co-Ownership.png" alt="Crown Heights co-ownership homes" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Crown Heights" propertyType="Co-ownership" label="Crown Heights co-ownership homes" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115397" />
      ...
      <PageContactSection topic="Crown Heights Co Ownership" />
    </>
  );
}
