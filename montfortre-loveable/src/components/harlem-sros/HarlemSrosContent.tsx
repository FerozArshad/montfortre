...
import harlemSrosGuide from "../../data/neighborhood-guides/harlem-sros.html?raw";
...
export default function HarlemSrosContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/migrated-live/Harlem-SROS-neigborhood-page.jpg" alt="Harlem SRO buildings" width="640" height="512" loading="eager" className="nbhd-hero-photo" />
            </div>
      ...
      <PageListingsSection market="Harlem" propertyType="SRO" label="Harlem SROs" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115357" />
      ...
      <section className="nbhd-intro" data-screen-label="Guide">
        <div className="nbhd-intro-inner">
          <div className="nbhd-intro-copy" data-reveal="">
            <NeighborhoodGuideBody html={harlemSrosGuide} />
          </div>
        </div>
      </section>
      ...
      <PageContactSection topic="Harlem SROs" />
    </>
  );
}
