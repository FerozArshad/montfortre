...
export default function ParkSlopeCoOpsContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/migrated-live/Park-Slope-Co-ops.png" alt="Park Slope co-op buildings" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Park Slope" propertyType="Co-op" label="Park Slope co-ops" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115400" />
      ...
      <PageContactSection topic="Park Slope Coops" />
    </>
  );
}
