...
function CatalogGroup({
  ...
  return (
    <div
      id={id}
      data-reveal=""
      className={first ? "svc-catalog-group" : "svc-catalog-group svc-catalog-group--next"}
    >
        ...
        <div className="svc-hero-inner">
          <div data-reveal="">
            ...
            <div className="svc-hero-ctas">
              ...
              <a href="tel:+16469701078" className="svc-hero-tel">
                (646) 970-1078
              </a>
            </div>
          ...
          <div data-reveal="" className="svc-hero-media">
            <div className="svc-hero-frame">
              <img src="/redesign-assets/migrated-live/Buying-a-condo-NYC-1.png" alt="NYC brownstone real estate" />
            </div>
            ...
            <CatalogGroup
              ...
              cards={[
                ...
                },
                {
                  ...
                  image: "/redesign-assets/services/coops-charges-vs-condos-common-charges.png",
                  alt: "NYC Condo vs Brownstone Calculator",
                  title: "NYC Condo vs Brownstone Calculator",
                  description: "See whether a condo or income-producing brownstone costs less each month.",
                  lazy: true,
                },
              ]}
            />
