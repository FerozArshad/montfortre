...
import GuideDownloadForm from "../shared/GuideDownloadForm";
        ...
        <div className="home-dl-inner">
          <div data-reveal="" className="home-dl-copy">
            ...
            <p className="home-dl-body">
              ...
              ? Taking the time to educate yourself on these 15 costly mistakes can make all the difference between a successful purchase and a disastrous one.
            </p>
            <GuideDownloadForm
              guide="15 Costly Mistakes Made When Buying a Brownstone"
              fileUrl="/redesign-assets/guides/nyc-brownstone-buyer-mistakes-2026-2027.pdf"
