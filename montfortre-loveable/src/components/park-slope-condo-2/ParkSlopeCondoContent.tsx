...
export default function ParkSlopeCondoContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/migrated-live/Park-Slope-Condo.png" alt="Park Slope condos" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Park Slope" propertyType="Condo" label="Park Slope condos" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115399" />
      ...
      <PageContactSection topic="Park Slope Condo" />
    </>
  );
}
