...
export default function BrooklynHeightsTownhousesContent() {
  return (
    <>
        ...
        <div className="nbhd-hero-inner">
          ...
          <div className="nbhd-hero-media" data-reveal="">
            <div className="nbhd-hero-frame">
              <img src="/redesign-assets/hoods/brooklyn-heights-townhouses.png" alt="Brooklyn Heights townhouses" width="640" height="512" loading="eager" />
            </div>
      ...
      <PageListingsSection market="Brooklyn Heights" propertyType="Townhouse" label="Brooklyn Heights townhouses" idxUrl="https://stanley.olridx.com/Search/Sales?idr=False#115388" />
      ...
      <section className="nbhd-intro" data-screen-label="Guide">
        <div className="nbhd-intro-inner">
          <div className="nbhd-intro-copy" data-reveal="">
            <NeighborhoodGuideBody html={bhTownhousesGuide} />
          </div>
        </div>
      </section>
