...
import { safeLeadSourceHref } from "../../lib/leadFormSecurity";
        ...
        {selected ? (
          <aside className="admin-card leads-detail">
            ...
            <dl className="leads-detail-dl">
              ...
              <div>
                ...
                <dd>
                  {selected.source_page ? (
                    safeLeadSourceHref(selected.source_page) ? (
                      <a href={safeLeadSourceHref(selected.source_page)!} target="_blank" rel="noreferrer">
                        {selected.source_page}
                      </a>
                    ) : (
                      selected.source_page
              ...
              {leadMetaEntries(selected.meta).map((entry) => (
                <div key={entry.label}>
                  <dt>{entry.label}</dt>
                  <dd>{entry.value}</dd>
                </div>
