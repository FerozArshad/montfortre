/** Frozen SEO for /the-ins-and-out-of-using-co-ownership-to-purchase-a-new-york-city-brownstone/ — generated from HTTrack; do not invent values. */

import type { PageSeo } from "../../../seo/types";

export const ARTICLE_TITLE = "The Ins and Out of Using Co-Ownership to Purchase a New York City Brownstone | Montfort Real Estate";

export const ARTICLE_METAS = [
  {
    "name": "description",
    "content": "Co-ownership is an excellent option to achieve homeownership in New York City. Click here to learn more."
  },
  {
    "name": "twitter:card",
  ...
  {
    "name": "twitter:title",
    "content": "The Ins and Out of Using Co-Ownership to Purchase a New York City Brownstone | Montfort Real Estate"
  },
  {
  ...
  {
    "name": "twitter:image",
    "content": "https://montfortre.com/redesign-assets/blog/the-ins-and-out-of-using-co-ownership-to-purchase-a-new-york-city-brownstone/featured-The-Ins-and-Out-of-Using-Co-Ownership-to-Purchase-a-New-York-City-Brownstone.png"
  },
  {
    "property": "og:locale",
    "content": "en_US"
  ...
  {
    "property": "og:url",
    "content": "https://montfortre.com/the-ins-and-out-of-using-co-ownership-to-purchase-a-new-york-city-brownstone/"
  },
  {
  ...
  },
  {
    ...
    "content": "2021-07-14T15:31:34+00:00"
  },
  {
    "property": "article:modified_time",
    "content": "2023-11-22T21:44:30+00:00"
  },
  {
...
export const ARTICLE_LINKS = [
  {
    "rel": "canonical",
    "href": "https://montfortre.com/the-ins-and-out-of-using-co-ownership-to-purchase-a-new-york-city-brownstone/"
  },
  {
    "rel": "icon",
...
export const ARTICLE_JSON_LD = [
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"item\":{\"@id\":\"https://montfortre.com/\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":2,\"item\":{\"@id\":\"https://montfortre.com/the-ins-and-out-of-using-co-ownership-to-purchase-a-new-york-city-brownstone/\",\"name\":\"The Ins and Out of Using Co-Ownership to Purchase a New York City Brownstone\"}}]}",
