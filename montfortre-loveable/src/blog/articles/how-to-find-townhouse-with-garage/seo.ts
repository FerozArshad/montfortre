/** Frozen SEO for /how-to-find-townhouse-with-garage/ — generated from HTTrack; do not invent values. */

import type { PageSeo } from "../../../seo/types";

export const ARTICLE_TITLE = "How to Find a Townhouse With Garage or Parking | Montfort Real Estate";

export const ARTICLE_METAS = [
  {
    "name": "description",
    "content": "Discover your dream townhouse in New York City without breaking the bank on parking! We understand that parking in the city can be costly, but fear not. We're here to guide you toward finding a townhouse with a garage."
  },
  {
    "name": "twitter:card",
  ...
  {
    "name": "twitter:title",
    "content": "How to Find a Townhouse With Garage or Parking | Montfort Real Estate"
  },
  {
  ...
  {
    "name": "twitter:image",
    "content": "https://montfortre.com/redesign-assets/blog/how-to-find-townhouse-with-garage/featured-New-York-Brownstone-parking-1.png"
  },
  {
    "property": "og:locale",
    "content": "en_US"
  ...
  {
    "property": "og:url",
    "content": "https://montfortre.com/how-to-find-townhouse-with-garage/"
  },
  {
  ...
  },
  {
    ...
    "content": "2022-09-28T16:22:03+00:00"
  },
  {
    "property": "article:modified_time",
    "content": "2024-07-29T23:31:34+00:00"
  },
  {
...
export const ARTICLE_LINKS = [
  {
    "rel": "canonical",
    "href": "https://montfortre.com/how-to-find-townhouse-with-garage/"
  },
  {
    "rel": "icon",
...
export const ARTICLE_JSON_LD = [
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"item\":{\"@id\":\"https://montfortre.com/\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":2,\"item\":{\"@id\":\"https://montfortre.com/how-to-find-townhouse-with-garage/\",\"name\":\"How to Find a Townhouse With Garage or Parking\"}}]}",
