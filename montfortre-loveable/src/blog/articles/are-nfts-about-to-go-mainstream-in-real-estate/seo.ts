/** Frozen SEO for /are-nfts-about-to-go-mainstream-in-real-estate/ — generated from HTTrack; do not invent values. */

import type { PageSeo } from "../../../seo/types";

export const ARTICLE_TITLE = "Are NFTs About to Go Mainstream in Real Estate? | Montfort Real Estate";

export const ARTICLE_METAS = [
  {
    "name": "description",
    "content": "Click here to learn how to buy real estate on the block chain."
  },
  {
    "name": "twitter:card",
  ...
  {
    "name": "twitter:title",
    "content": "Are NFTs About to Go Mainstream in Real Estate? | Montfort Real Estate"
  },
  {
  ...
  {
    "name": "twitter:image",
    "content": "https://montfortre.com/redesign-assets/blog/are-nfts-about-to-go-mainstream-in-real-estate/featured-ChatGPT-Image-11-jun-2026-19-48-53.png"
  },
  {
    "property": "og:locale",
    "content": "en_US"
  ...
  {
    "property": "og:url",
    "content": "https://montfortre.com/are-nfts-about-to-go-mainstream-in-real-estate/"
  },
  {
  ...
  },
  {
    ...
    "content": "2022-07-21T11:26:44+00:00"
  },
  {
    "property": "article:modified_time",
    "content": "2026-06-12T00:49:31+00:00"
  },
  {
...
export const ARTICLE_LINKS = [
  {
    "rel": "canonical",
    "href": "https://montfortre.com/are-nfts-about-to-go-mainstream-in-real-estate/"
  },
  {
    "rel": "icon",
...
export const ARTICLE_JSON_LD = [
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"item\":{\"@id\":\"https://montfortre.com/\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":2,\"item\":{\"@id\":\"https://montfortre.com/are-nfts-about-to-go-mainstream-in-real-estate/\",\"name\":\"Are NFTs About to Go Mainstream in Real Estate?\"}}]}",
