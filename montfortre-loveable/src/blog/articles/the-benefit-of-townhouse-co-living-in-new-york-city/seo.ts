/** Frozen SEO for /the-benefit-of-townhouse-co-living-in-new-york-city/ — generated from HTTrack; do not invent values. */

import type { PageSeo } from "../../../seo/types";

export const ARTICLE_TITLE = "The Benefit of Townhouse Co-Living In New York City | Montfort Real Estate";

export const ARTICLE_METAS = [
  {
    "name": "description",
    "content": "In a place like NYC, where real estate is costly, and inventory is limited,  more landlords should consider the numerous benefits of offering townhouse co-living housing to their residents.  Click here to learn more!"
  },
  {
    "name": "twitter:card",
  ...
  {
    "name": "twitter:title",
    "content": "The Benefit of Townhouse Co-Living In New York City | Montfort Real Estate"
  },
  {
  ...
  {
    "name": "twitter:image",
    "content": "https://assets.agentfire3.com/uploads/sites/312/2022/01/Blog-The-Benefit-of-Townhouse-Co-Living-In-New-York-City.jpg"
  },
  {
    "property": "og:locale",
    "content": "en_US"
  ...
  {
    "property": "og:url",
    "content": "https://montfortre.com/the-benefit-of-townhouse-co-living-in-new-york-city/"
  },
  {
  ...
  {
    "property": "og:image",
    "content": "https://assets.agentfire3.com/uploads/sites/312/2022/01/Blog-The-Benefit-of-Townhouse-Co-Living-In-New-York-City-1024x768.jpg"
  },
  {
    "property": "article:published_time",
    "content": "2022-01-12T13:54:35+00:00"
  },
  {
    "property": "article:modified_time",
    "content": "2023-11-22T21:03:15+00:00"
  },
  {
...
export const ARTICLE_LINKS = [
  {
    "rel": "canonical",
    "href": "https://montfortre.com/the-benefit-of-townhouse-co-living-in-new-york-city/"
  },
  {
    "rel": "icon",
...
export const ARTICLE_JSON_LD = [
  ...
  "{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"item\":{\"@id\":\"https://montfortre.com/\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":2,\"item\":{\"@id\":\"https://montfortre.com/the-benefit-of-townhouse-co-living-in-new-york-city/\",\"name\":\"The Benefit of Townhouse Co-Living In New York City\"}}]}",
