...
Source of truth while developing: `montfortre-ghl-studio/` inside the Cursor `local-root` clone.  
On Lovable, the same files live at **repo root** (no `montfortre-ghl-studio/` prefix).
...
| `montfortre-ghl-studio/supabase/...` | `supabase/...` |
| `montfortre-ghl-studio/scripts/...` | `scripts/...` (CMS seed helpers) |
| `montfortre-ghl-studio/index.html` | `index.html` |
| `montfortre-ghl-studio/package.json` | merge into Lovable `package.json` (see below) |
| `montfortre-ghl-studio/vite.config.ts` | `vite.config.ts` |
| `montfortre-ghl-studio/tsconfig*.json` | `tsconfig*.json` |
| `montfortre-ghl-studio/tailwind.config.ts` / `postcss.config.*` | same at root |
| `montfortre-ghl-studio/CMS-ADMIN.md` | `CMS-ADMIN.md` |
| `montfortre-ghl-studio/LOVABLE-GO-LIVE.md` | `LOVABLE-GO-LIVE.md` |
| `montfortre-ghl-studio/.env.example` | `.env.example` |
...
When the Lovable git URL is available, clone to a **sibling** folder (example: `d:\montfortre\montfortre-loveable`), then overlay from `montfortre-ghl-studio/`.
...
| `tsconfig.json`, `tsconfig.app.json`, `tsconfig.node.json` | As present in `montfortre-ghl-studio/` |
...
1. Clone to sibling, e.g. `d:\montfortre\montfortre-loveable` (not inside `local-root` as `main`).
2. Overlay `src/`, `public/`, `supabase/` from `montfortre-ghl-studio/`.
