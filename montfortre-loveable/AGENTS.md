...
This is a React 18 + Vite + TypeScript SPA (`d:\montfortre\montfortre-ghl-studio`, remote `FerozArshad/montfortre`). Not Next.js.
...
**Lovable ship:** app paths map to Lovable **repo root** (drop `montfortre-ghl-studio/` prefix). Playbook: `LOVABLE-GO-LIVE.md`. CMS admin: `CMS-ADMIN.md`. Do not mix Lovable overlay with GitHub `main` / GHL paste.
