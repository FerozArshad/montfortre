-- Multi-recipient lead notifications + per-recipient delivery log.
-- Keeps the existing trigger → pg_net → notify-lead architecture.

-- ---------------------------------------------------------------------------
-- Recipients (max 4, managed from /admin/notifications)
-- ---------------------------------------------------------------------------
...
-- Seed from legacy single-recipient column when present.
...
-- ---------------------------------------------------------------------------
-- Extend notification header row
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Admin status + save (recipients array)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Trigger: pass notification_id to the Edge Function
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Edge Function callback: finalize deliveries (service_role)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Reconcile: parse notify-lead JSON (incl. partial delivery)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Test poll: parse notify-lead JSON like reconcile
-- ---------------------------------------------------------------------------
